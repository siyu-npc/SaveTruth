...
if(t+e+100>n&&H.off(window,"scroll",d),!!L&&console.log("onscroll,isLoading:"+P+";offset:"+F+";scrollHeight:"+n+";scrollTop:"+t+";innerHeight:"+e),
!(P||-1==F||F>0&&n-t-e>500)){
var o=+new Date;
P=!0,i(X.tips),m(X.loading);
var a="/mp/appmsg_comment?action=getcomment&scene="+U.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+M+"&offset="+F+"&limit="+Y+(window.send_time?"&send_time="+send_time:"");
try{
W++,W>1&&l(U.moreList,encodeURIComponent(a)),K.indexOf(a)>-1&&l(U.repeatList,encodeURIComponent(a)),
K.push(a);
}catch(s){}
!!L&&console.log("[Appmsg comment] start get comment data:"+a),N("[Appmsg comment] start get comment data, url:"+a),
O({
url:a,
type:"get",
success:function(e){
...
var d=+new Date-t;
c(n,d);
}else l(U.errList,"type:resperr;url:"+encodeURIComponent(a)+";ret="+s);
...
complete:function(){
P=!1,i(X.loading),H.off(window,"scroll",k);
}
});
}
}
...
1!=e.enabled?(T&&(T.style.display="none"),e.elected_comment=[],e.elected_comment_total_cnt=0):T&&(T.style.display="block"),
...
function _(){
S.log("tag1");
var e=s(X.input.value);
if(S.log("tag2"),!B.hasClass(X.submit,"btn_disabled")){
if(S.log("tag3"),e.length<1)return f("Comment cannot be empty");
if(S.log("tag4"),e.length>600)return f("Up to 600 characters");
...
var o="/mp/appmsg_comment?action=addcomment&scene="+U.scene+"&comment_id="+M+"&__biz="+biz+"&idx="+idx+"&appmsgid="+appmsgid+"&sn="+sn;
O({
url:o,
data:{
content:e,
...
case-6:
f("Too many comments. Try again later.");
break;

case-7:
f("You cannot write a comment as you didn't follow this Official Account");
break;

case-10:
f("Up to 600 characters");
break;

case-15:
f("Comment unavailable");
break;

default:
et=e,f("系统错误，请重试");
}
0!=m.ret&&l(U.addCommentErr,"type:resperr;url:"+encodeURIComponent(o)+";ret="+m.ret);
},
error:function(e){
S.log("shit;"+e.status+";"+e.statusText),l(U.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(o));
},
complete:function(){
...
function p(){
if(0==Q){
var e="/mp/appmsg_comment?action=getmycomment&scene="+U.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+M,t=document.getElementById("js_mycmt_loading");
Q=1,m(t),O({
url:e,
type:"get",
success:function(t){
...
if(0==i){
var a=n.my_comment,s=document.createDocumentFragment();
a&&a.length&&(g(a,s,"mine"),X.mylist.appendChild(s),m(X.mylist.parentNode)),Q=2;
...
$={};
for(var s,c=0;s=e[c];++c){
s.time=u(s.create_time),s.status="",s.logo_url=s.logo_url||a,s.logo_url=-1!=s.logo_url.indexOf("wx.qlogo.cn")?s.logo_url.replace(/\/132$/,"/96"):s.logo_url,
...
reply_list:[]
},s.is_mine=n?!1:!0,s.is_elected="elected"==n?1:s.is_elected,s.reply.reply_list.length>0&&(s.reply.reply_list[0].time=u(s.reply.reply_list[0].create_time),
...
s.new_appmsg=window.new_appmsg,m+=R.tmpl(D,s);
try{
var d=s.nick_name+s.content,r=!1,_=U.repeatContentID;
$[d]&&(r=!0,_=U.repeatContent),Z.indexOf(s.content_id)>-1&&(r=!0,_=U.repeatContentID),
Z.push(s.content_id),$[d]=!0,r&&l(_,encodeURIComponent(JSON.stringify({
comment_id:M,
...
function w(){
var e="1"===x.getParam("js_my_comment");
e&&h(!0);
}
function h(e){
...
var o=parseInt(n.dataset.status),m=0==o?1:0,i=n.dataset.contentId,a="/mp/appmsg_comment?action=likecomment&scene="+U.scene+"&like="+m+"&__biz="+biz+"&appmsgid="+appmsgid+"&comment_id="+M+"&content_id="+i;
...
I(t),window.test_comment_data||O({
...
function E(e){
var t=e.delegatedTarget,n=t.getAttribute("data-my-id"),a="/mp/appmsg_comment?action=delete&scene="+U.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&comment_id="+M+"&my_id="+n;
confirm("确定删除吗？")&&O({
url:a,
success:function(e){
var a,s=t;
...
s&&(s.parentNode.removeChild(s),a=document.getElementById("cid"+n),a&&a.parentNode.removeChild(a),
...
var B=e("biz_common/dom/class.js"),D=e("appmsg/cmt_tpl.html.js"),T=document.getElementById("js_cmt_area"),x=new C(window.location.href),z=e("biz_common/utils/wxgspeedsdk.js"),L=location.href.indexOf("vconsole=1")>0||document.cookie&&document.cookie.indexOf("vconsole_open=1")>-1?!0:!1,M=0;
...
!!L&&console.log("comment_id:"+M+";uin:"+uin+";key:"+key),-1!=navigator.userAgent.indexOf("MicroMessenger")||window.test_comment_data||(T&&(T.style.display="none"),
M=0,window._has_comment=!1),0==M||!uin||!key)return void(window._has_comment=!1);
var H=e("biz_common/dom/event.js"),O=e("biz_wap/utils/ajax.js"),R=(e("biz_common/utils/string/html.js"),
...
el_like.setAttribute("like",0),likeNum>0&&"100000+"!==tmpHtml&&(el_likeNum.innerHTML=likeNum-1==0?"Like":likeNum-1)):(el_like.setAttribute("like",1),
