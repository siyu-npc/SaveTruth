...
}),(document.documentElement.scrollTop||window.pageYOffset||document.body.scrollTop)<document.getElementById("img-content").offsetTop?(l.invoke("setPageTitle",{
title:""
},function(){}),A=!1):(l.invoke("setPageTitle",{
title:window.title
},function(){}),A=!0),window.onscroll=function(){
var e=document.documentElement.scrollTop||window.pageYOffset||document.body.scrollTop;
e>=document.getElementById("img-content").offsetTop&&0==A?(l.invoke("setPageTitle",{
title:window.title
},function(){}),A=!0):(l.invoke("setPageTitle",{
title:""
},function(){}),A=!1);
});
