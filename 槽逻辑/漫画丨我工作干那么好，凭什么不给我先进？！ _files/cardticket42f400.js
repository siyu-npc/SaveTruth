...
e.find(".js_video_play_controll").hide(),e.find(".js_video_flow").hide(),this.__hasBeginPlay=!0,
...
status:"loading",
subStatus:"seeked"
}),n.play()),t.__seeking=!1,C("video seeked event");
...
function e(){
if(i.__userplaytime=!0,H)return location.href=i.opt.src,!1;
i.changeStatus({
status:"loading",
subStatus:"preload"
});
...
var w,b,P,S,j=0,C=!1,B=0,F=0,x=i.__getDuration(),D=0,M=1,E=window.user_uin||0,V=0!==E&&Math.floor(E/100)%1e3<M,L=!1,I=0;
...
var s=t-w,r=n-b.x,l=a-b.y,d=Math.sqrt(Math.pow(r,2)+Math.pow(l,2))+F,_=Math.min(Math.ceil(d/s),6);
B=Math.floor(.1*d+.2*_*_*_)*Math.ceil(x/500),F=0==B?d:0,0>r&&(B=-B);
var u=180*Math.atan2(l,r)/Math.PI;
C||(u>=-30&&30>=u&&++j,(u>=150&&180>=u||u>=-180&&-150>=u)&&--j,(j>=4||-4>=j)&&(5>=d?j=0:(I=Math.max(I,_),
...
if(C){
if(i.play(D),n.find(".js_forward").css("display","none"),V&&((new Image).src="/mp/jsmonitor?idkey=28307_29_1",
!L)){
var t=(new Date,{
...
(new Image).src="/mp/jsmonitor?idkey=28307_31_1;28307_33_"+s+";28307_34_"+I,L=!0;
}
i._seekReport();
}
B=0,C=!1,j=0;
...
o._trigger("userplay"),o.opt.notPauseOtherVideoWhenPlay||p.broadcastMessage({
type:"broadcastPlay",
data:{
id:this.id
}
...
o.log.loadwait_start=+new Date,(!n.attr("src")||i)&&(n.attr("src",e),v.proxyPreloadExper()&&v.proxyPreloadExper().isUsePreload&&u.os.ios&&!o.opt.ad_muted_btn&&!function(){
var e=function t(){
...
var i=t.status,o=t.subStatus;
t.status=e.status,t.subStatus=e.subStatus;
var n="player statusChange, preStatus:"+i+"; status:"+t.status+"; preSubStatus:"+o+"; subStatus:"+t.subStatus;
this._jsapiLog(n),C(n),p.broadcastMessage({
type:"statusChange",
data:{
id:this.id,
preStatus:i,
