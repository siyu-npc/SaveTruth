...
var n=e.container;
if(!n)return!1;
for(var o=n.getElementsByTagName("a")||[],i=0,a=o.length;a>i;++i)!function(n){
var i=o[n],a=i.getAttribute("href");
if(!a)return!1;
var c=0,s=i.innerHTML;
...
function t(e,t,d){
var c=[],p=m.checkNeedAds(),g=p.is_need_ad,w=p.both_ad,l=i("mock"),v=i("rtx"),f="/mockserver/mockservercgi-bin/offerTestCase/mmbizwap/mp/getappmsgad",_="/mp/getappmsgad";
t=t||{},e||(e=[]);
...
}catch(l){}else o("[Appmsg] success get async ad data, async data is empty"),a(c);
d&&d();
},
error:function(){
o("[Appmsg] error get async ad data, biz="+biz+", mid="+mid),a(c);
}
});
}
function a(e){
...
var o=e("appmsg/log.js"),s=e("biz_wap/utils/ajax.js"),r=e("rt/appmsg/getappmsgext.rt.js"),m=e("a/a.js");
return{
getAdData:t
};
