...
function a(e){
try{
for(var i=window.pageYOffset||document.documentElement.scrollTop,a=window.innerHeight||document.documentElement.clientHeight,m=0;m<K.length;m+=T){
var l=K[m];
if(!(l.offsetTop>i+a+100)){
var w=g.attr(l,"data-cpsstatus");
if("hide"==w){
l.setAttribute("data-cpsstatus","loading");
for(var u=""+m,f=1,h=m+1;h<K.length&&m+T>h;h++)u=u+"%2c"+h,f++;
...
e>=40&&!S?(document.title=window.title,S=!0):40>e&&S&&(document.title="",S=!1);
}
function O(e,t){
var o={
...
K[N].setAttribute("data-cpsstatus","hide"),K[N].setAttribute("data-showed","no");
var M={
cps_isready:!1,
cps_state:"",
pid_type:"",
...
source_logo_url:"",
is_ad:1
},D=g.attr(K[N],"data-templateid");
"list"==D?K[N].innerHTML=r.tmpl(p,M):"banner"==D?K[N].innerHTML=r.tmpl(d,M):"card"==D&&(K[N].innerHTML=r.tmpl(s,M));
}
}catch(L){
console.log(L);
}
var W,H=null;
o(),y.on(window,"scroll",o),a(),y.on(window,"scroll",k),window.is_new_msg&&-1!=navigator.userAgent.indexOf("MicroMessenger")&&(window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
A.invoke("currentMpInfo",{
brandName:window.title,
brandIcon:hd_head_img.replace(/\/0$/,"/132")
},function(){}),y.on(window,"load",function(){
document.title="",S=!1,z();
}),window.onscroll=z,window.addEventListener("pageshow",z));
...
try{
if(top!=window&&(!top||top&&location.href&&P.test(location.href))&&!window.isSg)throw new Error("in iframe");
}catch(L){
var V="",Q=new Image;
Q.src=("http://mp.weixin.qq.com/mp/jsreport?key=4&content=biz:"+biz+",mid:"+mid+",uin:"+uin+"[key4]"+V+"&r="+Math.random()).substr(0,1024);
}
if(window.isInWeixinApp()&&/#rd$/.test(location.href)&&!window.isWeixinCached&&!window.__second_open__){
var F=-1!=location.href.indexOf("?")?"&":"?";
location.replace(location.href.replace(/#rd$/,F+"rd2werd=1#wechat_redirect"));
}
...
e("appmsg/share.js");
var Y=b(1e3*parseInt(window.modify_time)),$=Y.format("YYYY-MM-DD"),X=document.getElementById("js_modify_time");
if(X&&(X.innerHTML=$),window.isSg||"mp.weixin.qq.com"==location.host){
...
var et=-1!=navigator.userAgent.indexOf("TBS/"),tt=function(e,t){
O(e,function(e,o){
...
et&&1>=n&&(i.lossy=i.lossless=i.alpha=1,window.logs.webplog=i);
...
(q||navigator.userAgent.indexOf("Br_trunk")>-1)&&h.isIOS&&(d||s)&&!p?(console.info("[HEVC代理] 当前版本可以启用HEVC代理"),
...
tt("lossy",e),tt("lossless",e),tt("alpha",e),tt("animation",e);
};
window.webp=!1,ot(function(){
it(function(t){
function o(e){
...
var i=e.__retryload;
return i=0,t=t.https2http(),e.__retryload=i,e.src=G.addParam(t,"retryload",i,!0),
!1;
};
y.on(e,"click",i);
}
...
l&&44206!=i&&_?(o=G.addParam(o,"tp","wxpic",!0),window.__addIdKeyReport("28307",91)):window.webp&&(o=G.addParam(o,"tp","webp",!0),
...
o=o.replace(u,"http://m.qpic.cn"),o=G.addParam(o,"wx_lazy","1",!0);
var f=h.gtVersion("6.5.13",!0)&&o.isGif(),v=h.gtVersion("6.8.0",!0)&&o.canHevc();
return B&&(f||v)&&(window.__addIdKeyReport("28307",106),o=G.addParam(o,"tp","wxpic",!0),
o=B+"hevc?url="+encodeURIComponent(o)+"&type="+o.getOriginImgType()),"anonymous"==e.crossOrigin&&(o=G.addParam(o,"wx_co","1",!0)),
...
var nt=e("appmsg/copyright_report.js");
!function(){
...
try{
var at=document.getElementById("js_author_name");
if(at){
var rt="";
y.on(at,"click",function(){
return l.hasClass(at,"rich_media_meta_link")?window.is_temp_url?(i("预览状态下不能操作"),
!1):at.getAttribute("data-rewardsn")?1!=at.getAttribute("data-canreward")?!1:(rt="https://mp.weixin.qq.com/mp/author?action=show&author_id="+author_id+"&rewardsn="+at.getAttribute("data-rewardsn")+"&timestamp="+at.getAttribute("data-timestamp")+"&__biz="+window.biz+"&appmsgid="+window.appmsgid+"&idx="+window.idx+"&scene=142&rscene=129#wechat_redirect",
...
-1==e.err_msg.indexOf("ok")&&(location.href=rt);
})):location.href=rt,!1)):!1:!1;
});
}
}catch(L){}
var dt=e("appmsg/outer_link.js");
if(new dt({
...
var st=e("appmsg/review_image.js"),pt=document.getElementById("js_cover"),ct=[];
pt&&ct.push(pt),new st({
container:document.getElementById("js_content"),
...
if(nt.card_pv_report(),Math.random()<.01)try{
...
var lt=Math.random();
if(2e-4>lt)try{
for(var wt=document.getElementsByTagName("img"),_t=window.screen.height,gt=window.screen.width,ut=0,ft=window.devicePixelRatio,ut="",N=0,ht=wt.length;ht>N;N++){
var vt=wt[N].getAttribute("data-src");
if(vt){
var yt=wt[N].getBoundingClientRect();
ut+=gt+"|"+_t+"|"+yt.left.toFixed(2)+"|"+(gt-yt.right).toFixed(2)+"|"+yt.width.toFixed(2)+"|"+ft.toFixed(2)+"|"+vt+";";
}
}
_({
