define("a/a_report.js",["biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","biz_wap/utils/mmversion.js","appmsg/log.js","a/a_sign.js"],function(e){
"use strict";
function t(e,t){
var n="https:"==location.protocol?1500:1200,c=window.__report,l="/mp/advertisement_report?r="+Math.random()+"&ascene="+encodeURIComponent(window.ascene||-1)+"&",u=[],g=!1,m=!1;
for(var w in e)e.hasOwnProperty(w)&&u.push(w+"="+e[w]);
var f=2;
1==window.__ad_has_exposure&&(f=1),u.push("has_exposure="+f),l+=u.join("&");
var y="trace_id="+e.tid+"&product_type="+e.pt+"&jump_url="+e.url+"&logtype=3&url="+encodeURIComponent(location.href)+"&rl="+e.rl;
e.tid&&p.gtVersion("6.3.22",!0)&&s.invoke("adDataReport",{
ad_info:y,
need_record_page_operation:1
},function(){}),_("[Ad report] url="+l),2==f&&window.__addIdKeyReport("68064",0),
window.__ad_test_exposure||window.__addIdKeyReport("68064",7),d.createSign(e,function(o,s,p,d,u){
l+="&ad_sign_data="+o+"&ad_sign_k1="+s+"&ad_sign_k2="+p+"&ad_sign_md5="+d,_("[Ad click real report] url="+l),
c&&c(123),i({
url:l,
mayAbort:!0,
type:"GET",
success:function(e){
c&&c(56+a),_("[Ad report suc]"+e),m=!0;
},
error:function(e){
c&&c(57+a),_("[Ad report error]"+e.status+":"+e.responseText);
},
complete:function(){
g||(g=!0,!!t&&t()),_("[Ad report complete]");
},
async:!0
}),setTimeout(function(){
g||(g=!0,window.__ajaxtest="1",c&&c(112),!!t&&t(),_("[Ad report timeout complete]"));
},n),setTimeout(function(){
m||i({
url:l,
type:"GET",
success:function(e){
c&&c(113+a),_("[Ad report suc retry]"+e);
},
error:function(e,t){
...
function r(e,t,r,o,n,a,s){
var p=s,_=0;
if(n.viewid&&(_=n.viewid.length),console.log("[reportUrlLength] length report",p.length,_,p.length+_),
p.length+_>=4e3){
...
aid:"",
log_type:1,
ext_info:"[url length:"+p.length+"rl length:"+a.rl.length+"]"+p.substring(0,3900)
}]
});
i({
...
var i=e("biz_wap/utils/ajax.js"),n=location.protocol,a="https:"==n?5:0,s=e("biz_wap/jsapi/core.js"),p=e("biz_wap/utils/mmversion.js"),_=e("appmsg/log.js"),d=e("a/a_sign.js");
return{
AdClickReport:t
};
...
query:r.search,
params:function(){
for(var e,t={},o=r.search.replace(/^\?/,"").split("&"),n=o.length,a=0;n>a;a++)o[a]&&(e=o[a].split("="),
t[e[0]]=e[1]);
return t;
}(),
...
return t&&t[1]&&parseInt(t[1].split("_")[0],10)>=12?void n.invoke("launchApplication",{
schemeUrl:e
},function(){}):void n.invoke("downloadAppInternal",{
appUrl:e
},function(t){
t.err_msg&&-1!=t.err_msg.indexOf("ok")||OpenUrlWithExtraWebview("/mp/ad_redirect?url="+encodeURIComponent(e)+"&ticket="+r);
});
}
var n=e("biz_wap/jsapi/core.js");
return{
