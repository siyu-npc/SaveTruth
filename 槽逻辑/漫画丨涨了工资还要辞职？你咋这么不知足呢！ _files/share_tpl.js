...
"use strict";
var e;
if(parent==window)e=window;else try{
{
...
var n=e.user_uin,r=Math.floor(e.user_uin/100)%20;
n||(r=-1);
var d=function(){
return r>=0;
};
e.__webviewid||(e.__webviewid=+new Date+"_"+Math.ceil(1e3*Math.random()));
var a=function(){
var i=e.mid,t=e.idx,r="";
r=i&&t?i+"_"+t:"";
var d=e.__webviewid,a=[n,r,d].join("_");
return a;
},o=function(e){
if(20>r)try{
var t=e.vid||"",n={};
...
s=o&&w?o+"_"+w:t,n.type="undefined"!=typeof e.type?e.type:o&&w?1:2,n.id=s,n.hit_bizuin=e.hit_bizuin||"",
n.hit_vid=e.hit_vid||"",n.webviewid=a(),n.step=e.step||0,n.orderid=e.orderid||0,
n.ad_source=e.ad_source||0,n.traceid=e.traceid||0,n.ext1=e.ext1||"",n.ext2=e.ext2||"",
n.r=Math.random(),n.devicetype=parent.window.devicetype,n.version=parent.window.clientversion,
n.is_gray=d()?1:0,n.mid=o||"",n.idx=w||"",n.url=parent.window.location.href,n.screen_num=e.screen_num||0,
n.screen_height=e.screen_height||0,n.ori_status=e.ori_status||3,n.fromid=e.fromid||0,
n.sessionid=window.sessionid||"";
...
}else qs("educate_title").innerHTML="推荐到看一看",show(el_likeEducate),show(qs("educate_btn"));else sendRecommendAjax(1,"",1);
},isShow=function(e){
...
case 1:
el_toastMsg.innerHTML="好看",show(el_likeToast),setTimeout(function(){
hide(el_likeToast);
},1e3);
}
setBtnLike();
...
case 1:
el_toastMsg.innerHTML=4===e?"已发送":"好看",(4===e||5===e)&&(show(el_likeToast),setTimeout(function(){
hide(el_likeToast);
},1e3));
}
...
prompted){
case 0:
qs("educate_title").innerHTML="已推荐到看一看",show(el_likeEducate),show(educate_btn2),
prompted=1;
break;
...
},sendRecommendAjax=function(like,comment,type,clientType){
if(!haokanLock){
show(qs("js_loading"));
