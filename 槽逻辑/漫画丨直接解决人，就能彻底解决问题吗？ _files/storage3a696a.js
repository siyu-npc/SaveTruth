...
var k=f.app_info.down_count||0,E=f.app_info.app_size||0,I=f.app_info.app_name||"",z=f.app_info.category,O=["万","百万","亿"];
if(k>=1e4){
k/=1e4;
for(var S=0;k>=10&&2>S;)k/=100,S++;
k=k.toFixed(1)+O[S]+"次";
}else k=k.toFixed(1)+"次";
E=formSize(E),z=z?z[0]||"其他":"其他",I=formName(I),f.app_info._down_count=k,f.app_info._app_size=E,
...
if(X=f.crt_size,f.biz_info&&f.biz_info.head_img&&23==f.product_type&&(f.avatar=f.biz_info.head_img,
f.avatarTitle=f.biz_info.nick_name),(12==f.product_type||19==f.product_type)&&(L=!0,
f.app_info&&f.app_info.icon_url&&(f.avatar=f.app_info.icon_url,f.avatarTitle=f.app_info.appname)),
46==f.product_type&&f.game_info&&f.game_info.head_img&&(f.avatar=f.game_info.head_img,
...
if(5==e.watermark_type&&(a.btn_text="查看详情"),console.log("文中",e),e.biz_info&&e.biz_info.head_img&&23==e.product_type&&(e.avatar=e.biz_info.head_img,
