...
var p=o.reportVid||window.reportVid,s=o.reportMid||window.reportMid,d=o.reportVoiceid||window.reportVoiceid,w=o.reportWeappid||window.reportWeappid,r=[e,"action=share","action_type="+t,"scene="+(o.source||window.source),"ascene="+(o.ascene||window.ascene||-1),"req_id="+(o.req_id||window.req_id||""),"vid="+("undefined"!=typeof p?p.join(";"):""),"musicid="+("undefined"!=typeof s?s.join(";"):""),"voiceid="+("undefined"!=typeof d?d.join(";"):""),"weappid="+("undefined"!=typeof w?w.join(";"):""),"item_show_type="+(o.item_show_type||window.item_show_type||0),"content_url="+encodeURIComponent(window.location.href)];
