...
if(t+e+100>n&&A.off(window,"scroll",l),!($||-1==X||X>0&&n-t-e>500)){
...
var c="/mp/appmsg_comment?action=getcomment&scene="+P.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+R+"&offset="+X+"&limit="+Z+(window.send_time?"&send_time="+send_time:"");
try{
mt++,mt>1&&a(P.moreList,encodeURIComponent(c)),ot.indexOf(c)>-1&&a(P.repeatList,encodeURIComponent(c)),
ot.push(c);
}catch(d){}
...
var l=+new Date-t;
s(n,l);
}else a(P.errList,"type:resperr;url:"+encodeURIComponent(c)+";ret="+d);
Y("[Appmsg comment] get comment success");
},
error:function(){
a(P.errList,"type:ajaxerr;url:"+encodeURIComponent(c)),Y("[Appmsg comment] get comment ajax error");
},
complete:function(){
...
it++,it>1&&a(P.handleList,encodeURIComponent(JSON.stringify({
comment_id:R,
offset:X,
url:location.href
...
if(W.log("tag3"),e.length<1)return y("Comment cannot be empty");
if(W.log("tag4"),e.length>600)return y("Up to 600 characters");
...
var o="/mp/appmsg_comment?action=addcomment&scene="+P.scene+"&comment_id="+R+"&__biz="+biz+"&idx="+idx+"&appmsgid="+appmsgid+"&sn="+sn;
F({
url:o,
data:{
content:e,
...
default:
ct=e,y("System busy. Please try again later.");
}
0!=m.ret&&a(P.addCommentErr,"type:resperr;url:"+encodeURIComponent(o)+";ret="+m.ret);
},
error:function(e){
W.log("shit;"+e.status+";"+e.statusText),a(P.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(o));
},
complete:function(){
...
function p(){
if(0==V){
var e="/mp/appmsg_comment?action=getmycomment&scene="+P.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+R,t=document.getElementById("js_mycmt_loading");
V=1,m(t),F({
url:e,
type:"get",
success:function(t){
...
}else V=0,a(P.errComment,"type:resperr;url:"+encodeURIComponent(e)+";ret="+i);
},
error:function(){
V=0,a(P.errComment,"type:ajaxerr;url:"+encodeURIComponent(e));
},
complete:function(){
i(t);
}
...
try{
var _=s.nick_name+s.content,r=!1,p=P.repeatContentID;
nt[_]&&(r=!0,p=P.repeatContent),tt.indexOf(s.content_id)>-1&&(r=!0,p=P.repeatContentID),
tt.push(s.content_id),nt[_]=!0,r&&a(p,encodeURIComponent(JSON.stringify({
comment_id:R,
...
function k(e){
var t=e.delegatedTarget,n=t.getAttribute("data-my-id"),m="/mp/appmsg_comment?action=delete&scene="+P.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&comment_id="+R+"&my_id="+n;
confirm("确定删除吗？")&&F({
url:m,
success:function(e){
var m,c=t;
...
for(var s=document.querySelectorAll(".cid"+n),a=0;a<s.length;a++)s[a].parentNode.removeChild(s[a]);
...
e("biz_common/tmpl.js")),U=e("biz_wap/utils/fakehash.js"),Y=e("appmsg/log.js"),P={
scene:0,
idkey:"",
moreList:27,
repeatList:25,
...
window.innerWidth!==parseFloat(getComputedStyle(et.fakebar).width)&&(clearTimeout(at),
...
A.on(window,"scroll",l),A.on(window,"scroll",C),A.on(document.getElementById("js_cmt_write1"),"click",function(e){
...
if(!s[n.data.traceid]){
s[n.data.traceid]=!0;
var w,g,h,b,v=!!d&&d.target;
v&&(w=p.getX(v,"js_ad_link")+d.offsetX,g=p.getY(v,"js_ad_link")+d.offsetY,h=document.getElementsByClassName("js_ad_link")[0]&&document.getElementsByClassName("js_ad_link")[0].clientWidth,
...
var d=a("biz_common/dom/event.js"),i=a("biz_common/dom/class.js"),r=a("a/a_report.js"),l=r.AdClickReport,p=a("biz_wap/utils/position.js"),_=a("biz_common/utils/report.js"),c=a("biz_wap/jsapi/core.js"),u=a("biz_wap/utils/mmversion.js"),m=a("a/appdialog_confirm.js"),w=a("biz_wap/utils/openUrl.js"),g={
download:"下载",
downloading:"下载中",
paused:"继续",
downloaded:"安装",
gotodetail:"进入",
installed:"已安装"
},f=!1,h="com.tencent.android.qqdownloader",b=1060125,v=!1,k={},y=w.openUrlWithExtraWebview,j=w.openWebAppStore;
...
i.removeClass(n.btn,"btn_progress"),n.btn.innerHTML=g[a]);
}else i.removeClass(n.btn,"with_processor"),i.removeClass(n.btn,"btn_progress"),
n.btn.innerHTML=g[a],n.data.use_new_protocol>0&&"gotodetail"===a&&(n.btn.innerHTML="进入应用");
