...
var e=n.err_msg;
e.indexOf("get_install_state:yes")>-1&&(window.clearInterval(T),I=!0,d.innerHTML=z.installed);
});
}
function a(){
y&&s.invoke("queryDownloadTask",{
download_id:y
},function(e){
if(e&&e.state){
if("download_succ"==e.state){
o("download_succ"),i(p.is_appmsg?18:14,n),window.clearInterval(x),b=!1,j=!0,d.innerHTML=z.downloaded;
...
window.clearInterval(x),b=!1,t("下载失败"),d.innerHTML=z.download);
}
});
}
var d=n.btn;
if(!d)return!1;
var l={},p=n.adData,u="",_="",m=p.androiddownurl;
if(m&&m.match){
var w=/&channelid\=([^&]*)/,f=m.match(w);
f&&f[1]&&(u="&channelid="+f[1],p.androiddownurl=m.replace(w,""));
}
n.via&&(_=["&via=ANDROIDWX.YYB.WX.ADVERTISE",n.via].join("."));
var v=!1,g="com.tencent.android.qqdownloader",k=1060125,I=!1,b=!1,j=!1,y=0,x=null,T=null,z={
download:"下载",
downloading:"下载中",
downloaded:"安装",
installed:"已安装"
};
d.innerHTML=z.download,s.ready(function(){
s.invoke("getInstallState",{
packageName:g
},function(n){
var e=n.err_msg;
...
1*t>=k&&e.indexOf("get_install_state:yes")>-1&&(v=!0);
}),s.invoke("getInstallState",{
packageName:p.pkgname
},function(n){
var e=n.err_msg;
o("getInstallState @"+p.pkgname+" : "+e);
var a=e.lastIndexOf("_")+1,t=e.substring(a);
1*t>=p.versioncode&&e.indexOf("get_install_state:yes")>-1&&(I=!0,d.innerHTML=z.installed);
}),d.addEventListener("click",function(){
if(o("click @js_app_action"),!b){
if(I)return!1;
...
var a=n.err_msg;
o("installDownloadTask : "+a),a.indexOf("install_download_task:ok")>-1?T=setInterval(e,1e3):t("安装失败！");
}),!1;
var m=function(){
return v?(i(p.is_appmsg?16:12,n),void c("tmast://download?oplist=1,2&pname="+p.pkgname+u+_)):void s.invoke("addDownloadTask",{
task_name:p.appname,
task_url:p.androiddownurl,
extInfo:n.task_ext_info,
file_md5:p.md5sum
},function(e){
var l=e.err_msg;
o("addDownloadTask : "+l),l.indexOf("add_download_task:ok")>-1?(i(p.is_appmsg?15:11,n),
b=!0,y=e.download_id,o("download_id : "+y),d.innerHTML=z.downloading,x=setInterval(a,1e3)):t("调用下载器失败！");
});
};
return p.rl&&p.traceid?l[p.traceid]||(l[p.traceid]=!0,r({
url:"/mp/advertisement_report?report_type=2&type="+p.type+"&url="+encodeURIComponent(p.androiddownurl)+"&tid="+p.traceid+"&rl="+encodeURIComponent(p.rl)+"&__biz="+biz+"&ascene="+encodeURIComponent(window.ascene||-1)+"&pt="+p.pt+"&r="+Math.random(),
type:"GET",
timeout:1e3,
complete:function(){
l[p.traceid]=!1,m();
...
var l=(n("biz_common/dom/event.js"),n("biz_common/utils/report.js")),r=n("biz_wap/utils/ajax.js"),s=n("biz_wap/jsapi/core.js"),c=n("biz_wap/utils/openUrl.js").openUrlWithExtraWebview;
return d;
...
"use strict";
function o(a){
v("http://mp.weixin.qq.com/mp/ad_report?action=follow&type="+a+E.report_param);
}
function d(a,t){
...
t=t||0;
var n="";
if(document.getElementById("js_appdetail_action_0")&&(D=document.getElementById("js_appdetail_action_0").offsetWidth,
H=document.getElementById("js_appdetail_action_0").offsetHeight),104==E.data.pt?n='<i class="btn_processor" style="width:'+t+'%;"></i><span class="btn_processor_value js_btn_process">暂停('+t+"%)</span>":113==E.data.pt||114==E.data.pt?E.btn.innerHTML.indexOf("继续")>-1?(n=E.btn.innerHTML,
n=n.replace("继续","暂停")):n='<i class="btn_processor" style="width:'+t+'%;"></i><span class="btn_processor_value js_btn_process">暂停</span>':122==E.data.pt?(E.btn.innerHTML.indexOf("继续")>-1?(n=E.btn.innerHTML,
n=n.replace(/继续/g,"暂停")):0==z?n='<span class="btn_progress_inner js_btn_process" id="percent_btn_1" style="width:'+t+'%;"><span id="percent_btn_2" class="btn_progress_bd js_btn_process" style="width:'+D+'px;">暂停</span></span>暂停':document.getElementById("percent_btn_1").style.width=t+"%",
z=t):1==E.data.use_new_protocol?(D=E.btn.offsetWidth,H=E.btn.offsetHeight,E.btn.innerHTML.indexOf("继续")>-1?(n=E.btn.innerHTML,
n=n.replace(/继续/g,"暂停")):0==z?n='<span class="btn_progress_inner js_btn_process" id="percent_btn_1" style="width:'+t+'%;"><span id="percent_btn_2" class="btn_progress_bd js_btn_process" style="width:'+D+"px; line-height: "+H+'px">暂停下载</span></span>暂停下载':document.getElementById("percent_btn_1").style.width=t+"%",
z=t):n='<i class="btn_processor" style="width:'+t+'%;"></i><span class="btn_processor_value js_btn_process">'+t+"%</span>",
console.log(E.btn.innerHTML),!n)return;
E.btn.innerHTML=n,122==E.data.pt||1==E.data.use_new_protocol?f.addClass(E.btn,"btn_progress"):f.addClass(E.btn,"with_processor");
}else if("paused"==a){
var n="";
104==E.data.pt||113==E.data.pt||114==E.data.pt||122==E.data.pt||E.data.use_new_protocol>0?(n=E.btn.innerHTML,
n=n.replace(/暂停/g,"继续"),E.btn.innerHTML=n):(f.removeClass(E.btn,"with_processor"),
f.removeClass(E.btn,"btn_progress"),E.btn.innerHTML=I[a]);
}else f.removeClass(E.btn,"with_processor"),f.removeClass(E.btn,"btn_progress"),
E.btn.innerHTML=I[a],E.data.use_new_protocol>0&&"gotodetail"==a&&(E.btn.innerHTML="进入应用");
}
function s(a){
var t=a.js_app_rating,n=1*E.data.app_rating;
n>5&&(n=5),0>n&&(n=0);
...
s&&i&&s[0]&&i[0]&&(s=s[0],i=i[0],s.style.display="inline-block",f.addClass(s,o));
}
}
function i(a){
"undefined"!=typeof h&&h.log&&h.log(a);
}
function l(){
h.on("wxdownload:progress_change",function(a){
a.download_id==E.download_id&&d("downloading",a.progress);
});
}
function r(){
E.download_id&&h.invoke("queryDownloadTask",{
download_id:E.download_id
},function(a){
if(i("queryDownloadTask : "+a.state+"; dowloadid = "+E.download_id),a&&a.state){
if("download_succ"==a.state&&(d("downloaded"),window.clearInterval(E.clock)),"downloading"==a.state)return;
("download_fail"==a.state||"default"==a.state)&&(window.clearInterval(E.clock),window.clearInterval(E.install_clock),
e("下载失败"),d("download"));
}
});
}
function p(){
h.invoke("getInstallState",{
packageName:E.data.pkgname,
download_id:E.download_id
},function(a){
var t=a.err_msg;
t.indexOf("get_install_state:yes")>-1&&(i("getInstallState @app, version : "+t),
window.clearInterval(E.install_clock),d(E.url_scheme?"gotodetail":"installed"));
});
}
function _(){
h.invoke("pauseDownloadTask",{
packageName:E.data.pkgname,
download_id:E.download_id
},function(a){
...
function m(){
if(104==E.data.pt||113==E.data.pt||114==E.data.pt||122==E.data.pt||E.data.use_new_protocol>0&&12==E.data.product_type&&E.url_scheme)j.gtVersion("6.5.6",!0)?h.invoke("launchApplication",{
schemeUrl:E.url_scheme
},function(a){
-1==a.err_msg.indexOf("ok")&&x(E.url_scheme);
}):x(E.url_scheme);else{
var t=E.data.url,n=a("biz_common/utils/url/parse.js");
(!t||0!=t.indexOf("http://mp.weixin.qq.com/tp/")&&0!=t.indexOf("https://mp.weixin.qq.com/tp/"))&&(t="http://mp.weixin.qq.com/mp/ad_app_info?t=ad/app_detail&app_id="+E.data.app_id+(E.appdetail_params||"")+"&channel_id="+E.channelid+"&md5sum="+E.data.md5sum+"#wechat_redirect"),
E.url_scheme&&(t=n.join(t,{
is_installed:"1"
})),x(t);
}
}
...
var n=20;
if(("103"==E.data.pt||"104"==E.data.pt)&&s(a),"104"==E.data.pt||"113"==E.data.pt||"114"==E.data.pt||"122"==E.data.pt||E.data.use_new_protocol>0&&12==E.data.product_type){
var u=E.data.androiddownurl;
if(u&&u.match){
var f=/&channelid\=([^&]*)/,g=u.match(f);
g&&g[1]&&(E.channelid=g[1],E.data.androiddownurl=u.replace(f,""));
}
E.channelid&&(E.channelid="&channelid="+E.channelid),a.via&&(E.via=["&via=ANDROIDWX.YYB.WX.ADVERTISE",a.via].join("."));
}
h.ready(function(){
console.log("appcard info",E),("113"==E.data.pt||"114"==E.data.pt||"104"==E.data.pt||"122"==E.data.pt||E.data.use_new_protocol>0&&12==E.data.product_type)&&(h.invoke("getInstallState",{
packageName:O
},function(a){
var t=a.err_msg;
i("getInstallState @yingyongbao : "+t);
var n=t.lastIndexOf("_")+1,e=t.substring(n);
1*e>=C&&t.indexOf("get_install_state:yes")>-1&&(T=!0);
}),h.invoke("getInstallState",{
packageName:E.data.pkgname
},function(a){
var t=a.err_msg;
i("getInstallState @"+E.data.pkgname+" : "+t);
var n=t.lastIndexOf("_")+1,e=t.substring(n);
1*e>=E.data.versioncode&&t.indexOf("get_install_state:yes")>-1&&d(E.url_scheme?"gotodetail":"installed");
})),console.log("bind btn",E.btn.id),w.on(E.btn,"click",function(s){
if(console.log("app click",E),console.log(s.target),"installed"==E.app_status)return d("installed"),
!1;
if("gotodetail"==E.app_status)return o(74),m(),!1;
if("downloading"==E.app_status)return o(71),_(),!1;
if("paused"==E.app_status)return o(72),c(),!1;
if("downloaded"==E.app_status)return o(73),h.invoke("installDownloadTask",{
download_id:E.download_id,
file_md5:E.data.md5sum
},function(a){
var t=a.err_msg;
i("installDownloadTask : "+t),t.indexOf("install_download_task:ok")>-1?E.install_clock=setInterval(p,1e3):e("安装失败！");
}),!1;
var u=function(){
if("103"==E.data.pt||"111"==E.data.pt||"112"==E.data.pt||"121"==E.data.pt||E.data.use_new_protocol>0&&19==E.data.product_type){
o(23);
var t="http://"+location.host+"/mp/ad_redirect?url="+encodeURIComponent(E.data.appinfo_url)+"&ticket="+(E.data.ticket||window.ticket)+"#wechat_redirect";
E.url_scheme&&j.gtVersion("6.5.6",!0)?h.invoke("launchApplication",{
schemeUrl:E.url_scheme
},function(a){
-1==a.err_msg.indexOf("ok")&&x(t);
}):h.invoke("downloadAppInternal",{
appUrl:E.data.appinfo_url
},function(a){
a.err_msg&&-1!=a.err_msg.indexOf("ok")||x(t);
});
}else{
if(T)return o(16),void x("tmast://download?oplist=1,2&pname="+E.data.pkgname+E.channelid+E.via);
o(15);
var s=[E.data.adid,E.data.traceid,(E.data.pkgname||"").replace(/\./g,"_"),E.data.source,n,a.engine].join("."),_=function(a,t,n){
console.log("addDownloadTask : "+a.data.appname+","+a.data.androiddownurl+","+t+","+a.data.md5sum),
h.invoke("addDownloadTaskStraight",{
...
var o=e.err_msg;
o.indexOf("ok")>-1?n&&n(e):h.invoke("addDownloadTask",{
task_name:a.data.appname,
task_url:a.data.androiddownurl,
extInfo:t,
file_md5:a.data.md5sum
},n);
}),a.url_scheme&&j.isAndroid&&j.gtVersion("6.5.6",!0)&&h.invoke("writeCommData",{
...
console.log("addDownloadTask : "+E.data.appname+","+E.data.androiddownurl+","+s+","+E.data.md5sum),
_(E,s,function(a){
var t=a.err_msg;
i("addDownloadTask : "+t),t.indexOf("ok")>-1?(E.download_id=a.download_id,i("download_id : "+E.download_id),
d("downloading"),E.clock=setInterval(r,1e3),E.install_clock=setInterval(p,1e3),l()):e("调用下载器失败！");
});
}
},w=function(){
...
if(!t[E.data.traceid]){
t[E.data.traceid]=!0;
var f,g,v,I,O=!!s&&s.target;
O&&(f=k.getX(O,"js_ad_link")+s.offsetX,g=k.getY(O,"js_ad_link")+s.offsetY,v=document.getElementsByClassName("js_ad_link")[0]&&document.getElementsByClassName("js_ad_link")[0].clientWidth,
...
var w=a("biz_common/dom/event.js"),f=a("biz_common/dom/class.js"),g=a("a/a_report.js"),b=g.AdClickReport,k=a("biz_wap/utils/position.js"),v=a("biz_common/utils/report.js"),h=a("biz_wap/jsapi/core.js"),j=a("biz_wap/utils/mmversion.js"),y=a("a/appdialog_confirm.js"),x=a("biz_wap/utils/openUrl.js").openUrlWithExtraWebview,I={
download:"下载",
downloading:"下载中",
paused:"继续",
downloaded:"安装",
gotodetail:"进入",
installed:"已安装"
},T=!1,O="com.tencent.android.qqdownloader",C=1060125,z=0,D=0,H=0,E={
app_status:"download",
btn:null,
download_id:0,
clock:null,
...
var k=f.app_info.down_count||0,I=f.app_info.app_size||0,E=f.app_info.app_name||"",O=f.app_info.category,z=["万","百万","亿"];
if(k>=1e4){
k/=1e4;
for(var S=0;k>=10&&2>S;)k/=100,S++;
k=k.toFixed(1)+z[S]+"次";
}else k=k.toFixed(1)+"次";
I=formSize(I),O=O?O[0]||"其他":"其他",E=formName(E),f.app_info._down_count=k,f.app_info._app_size=I,
f.app_info._category=O,f.app_info.app_name=E,u={
appname:f.app_info.app_name,
...
DomEvent.off(window,"scroll",W));
},M=adDatas.ads;
for(var N in M)if(0==N.indexOf("pos_")){
var u=M[N],f=!!u&&u.a_info;
if(u&&f){
if(2!=m){
if(0==f.pos_type){
if(f.new_appmsg=window.new_appmsg,js_bottom_ad_area.innerHTML=TMPL.tmpl(a_tpl,f),
111==f.pt||112==f.pt||113==f.pt||114==f.pt){
var R=document.getElementsByClassName("js_download_app_card")[0],H=R.offsetWidth,P=Math.floor(H/2.875);
P>0&&(R.style.height=P+"px");
}
...
var Y="&tid="+f.traceid+"&uin="+uin+"&key="+N+"&ticket="+(f.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+f.adid+"&ad_engine=0&pos_type="+pos_type+"&exp_id="+f.exp_info.exp_id+"&exp_value="+f.exp_info.exp_value+"&r="+Math.random();
f.report_param=Y;
}
...
-1==e.err_msg.indexOf("ok")&&OpenUrlWithExtraWebview(g.app_info.url_scheme);
});
...
if("102"==d.pt){
var z=require("a/android.js"),g=15,y=d.pkgname&&d.pkgname.replace(/\./g,"_");
return void new z({
