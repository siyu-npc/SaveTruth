...
var v=null,g=!0,y=!1;
if(a.isAndroid&&a.gtVersion("6.6.6",!0)&&(y=!0),console.log(r),r){
...
b=document.documentElement.clientHeight||window.innerHeight,_.isPlay()&&(s.offsetTop>h+b-s.offsetHeight/2||s.offsetTop+s.offsetHeight/2<h))_.pause();else if(!_.isPlay()&&c.canSupportAutoPlay&&("wifi"==window.networkType||"4g"==window.networkType)&&!(s.offsetTop>h+b+s.offsetHeight/2||s.offsetTop+s.offsetHeight<h-s.offsetHeight/2)){
if(a.isAndroid&&!y)return;
d.invoke("getBackgroundAudioState",{},function(i){
if(/:ok$/.test(i.err_msg)&&1*i.paused==0&&i.src);else{
if("56"==window.ascene)return;
...
g=!1):(_.triggerMuted(!0),g=!0),t(132,e.report_param);else if(!_.isPlay())return _.__beginPlayHandler(),
...
document.getElementById("js_bottom_ad_area")),l=e("biz_wap/utils/ajax.js"),u=!1,c=e("biz_wap/utils/device.js");
return o;
