...
return e&&e[1]&&parseInt(e[1].split("_")[0],10)>=12?void w("http://"+location.host+"/mp/ad_redirect?url="+encodeURIComponent(a)+"&ticket="+t+"#wechat_redirect"):void u.invoke("downloadAppInternal",{
appUrl:a
},function(e){
e.err_msg&&-1!=e.err_msg.indexOf("ok")||w("http://"+location.host+"/mp/ad_redirect?url="+encodeURIComponent(a)+"&ticket="+t+"#wechat_redirect");
});
}
function d(a){
this.g={
...
if(l&&l.match){
var _=/&channelid\=([^&]*)/,w=l.match(_);
w&&w[1]&&(e.channelid=w[1],e.data.androiddownurl=l.replace(_,""));
}
...
-1==a.err_msg.indexOf("ok")&&s(e.data.appinfo_url,d);
...
if(!d[e.data.traceid]){
d[e.data.traceid]=!0;
var w,f,b,v,k=!!i&&i.target;
k&&(w=c.getX(k,"js_ad_link")+i.offsetX,f=c.getY(k,"js_ad_link")+i.offsetY,b=document.getElementsByClassName("js_ad_link")[0]&&document.getElementsByClassName("js_ad_link")[0].clientWidth,
...
var i=a("biz_common/dom/event.js"),r=a("biz_common/dom/class.js"),l=a("a/a_report.js"),p=l.AdClickReport,c=a("biz_wap/utils/position.js"),_=a("biz_common/utils/report.js"),u=a("biz_wap/jsapi/core.js"),m=a("biz_wap/utils/mmversion.js"),g=a("a/appdialog_confirm.js"),w=a("biz_wap/utils/openUrl.js").openUrlWithExtraWebview,f={
download:"下载",
downloading:"下载中",
paused:"继续",
downloaded:"安装",
