...
function s(e){
var t=window.innerWidth||document.documentElement.innerWidth,r=(Math.ceil((y-188)/42)+1)*Math.floor((t-15)/42);
...
p.innerText="Reply by author",Math.random()<.05?p.innerText="Reply by author":Math.random()>.05&&Math.random()<.1&&(p.innerText="Reply by author"),
document.getElementById("js_reward_total_text").innerText="喜欢";
}
x=e.reward_head_imgs;
var f=w();
j.reward&&(author_id||h.isAndroid)&&1==e.can_reward?(n(j.reward),u.on(window,"load",function(){
...
e("biz_wap/utils/mmversion.js")),f=e("appmsg/appmsgext.js"),v=e("appmsg/open_url_with_webview.js"),y=window.innerHeight||document.documentElement.clientHeight,j={
...
var z=f.mp_shop_info.pid||"",S=f.mp_shop_info.outer_id||"";
u={
pid:z,
outer_id:S,
pt:g,
...
}else if(4==f.pos_type&&_checkShowCpc(f)){
f=_parseExpCpc(f);
var X=!1;
...
function _checkShowCpc(e){
if(globalAdDebug)return!0;
if(js_cpc_area){
var a,i=(document.documentElement.clientHeight||window.innerHeight)/2,t=js_cpc_area.offsetTop,n=contentWrp.offsetHeight;
if(i>t?a=1:t<(document.documentElement.clientHeight||window.innerHeight)&&(a=2),
a&&e){
