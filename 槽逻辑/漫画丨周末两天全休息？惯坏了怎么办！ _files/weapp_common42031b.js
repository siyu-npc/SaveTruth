...
{
var c=[],p=r.checkNeedAds(),g=p.is_need_ad,w=p.both_ad;
-1!=location.href.indexOf("mock_ad=");
}
i=i||{},e||(e=[]);
for(var l=0;l<e.length;l++)0==e[l].indexOf("wxv")&&c.push(e[l]);
console.info("[广告发送请求] 是否拉取广告",g),o({
url:"/mp/getappmsgad?f=json&mock="+m("mock"),
data:{
r:Math.random(),
__biz:biz,
...
sn:sn,
idx:idx,
scene:i.scene||window.scene,
title:i.title||encodeURIComponent(window.msg_title.htmlDecode()),
ct:i.ct||window.ct,
abtest_cookie:i.abtest_cookie||window.abtest_cookie||"",
devicetype:"string"==typeof i.devicetype?i.devicetype:window.devicetype.htmlDecode(),
version:"string"==typeof i.version?i.devicetype:window.clientversion.htmlDecode(),
is_need_ad:g,
both_ad:w,
send_time:i.send_time||window.send_time||"",
msg_daily_idx:i.msg_daily_idx||window.msg_daily_idx,
...
var i;
if(window.can_see_complaint=e.can_see_complaint,r.afterGetAdData(p,e),0==g?(i=p._adInfo,
i||(i={
advertisement_num:0
...
i.advertisement_info)for(var o=0;o<i.advertisement_info.length;o++)i.advertisement_info[o].cdg_appid=i.appid,
i.advertisement_info[o].vid&&(window.originalVideoAdFramesAdData[i.advertisement_info[o].vid]=d(i.advertisement_info[o]));
if(window.originalVideoAdFramesUnsetList&&0!=window.originalVideoAdFramesUnsetList.length)for(var s,m=document.getElementsByTagName("iframe"),o=0;o<window.originalVideoAdFramesUnsetList.length;o++)for(var w=0;w<m.length;w++)if(m[w].dataset&&m[w].dataset.mpvid==window.originalVideoAdFramesUnsetList[o]){
window.originalVideoAdFramesAdData[m[w].dataset.mpvid]||(window.originalVideoAdFramesAdData[m[w].dataset.mpvid]={}),
s=window.originalVideoAdFramesAdData[m[w].dataset.mpvid],m[w].contentWindow.postMessage({
action:"receiveOriginalVideoData",
vid:window.originalVideoAdFramesUnsetList[o],
adData:s
},"*");
break;
}
...
}catch(l){}else n("[Appmsg] success get async ad data, async data is empty"),t(c);
a&&a();
},
error:function(){
n("[Appmsg] error get async ad data, biz="+biz+", mid="+mid),t(c);
}
});
}
function t(e){
...
var n=e[t],o=typeof n;
n="string"==o?n.htmlDecode():n,"object"==o&&(n="[object Array]"==Object.prototype.toString.call(n)?a(n):d(n)),
i.push(n);
}
return i;
}
...
var n=e("appmsg/log.js"),o=e("biz_wap/utils/ajax.js"),s=e("rt/appmsg/getappmsgext.rt.js"),r=e("a/a.js");
return{
getAdData:i
};
...
var p=i.reportVid||window.reportVid,r=i.reportMid||window.reportMid,d=i.reportVoiceid||window.reportVoiceid,a=i.reportWeappid||window.reportWeappid,w=[],_=[];
if("undefined"==typeof i.ori_status_arr||"undefined"==typeof i.hit_bizuin_arr)for(var u=s.getVideoInfo(),c=0;c<p.length;c++){
var f=p[c];
w.push(u[f]&&"undefined"!=typeof u[f].ori_status?u[f].ori_status:0),_.push(u[f]&&"undefined"!=typeof u[f].hit_bizuin?u[f].hit_bizuin:"");
}else w=i.ori_status_arr,_=i.hit_bizuin_arr;
var h=[e,"action=share","action_type="+t,"scene="+(i.source||window.source),"ascene="+(i.ascene||window.ascene||-1),"req_id="+(i.req_id||window.req_id||""),"vid="+("undefined"!=typeof p?p.join(";"):""),"musicid="+("undefined"!=typeof r?r.join(";"):""),"voiceid="+("undefined"!=typeof d?d.join(";"):""),"weappid="+("undefined"!=typeof a?a.join(";"):""),"item_show_type="+(i.item_show_type||window.item_show_type||0),"ori_status_arr="+w.join(";"),"hit_bizuin_arr="+_.join(";"),"top_stories="+(i.top_stories||0),"content_url="+encodeURIComponent(window.location.href)];
i.hotspotjson?h.push("hotspotjson="+i.hotspotjson):window.hotspotInfoList&&h.push("hotspotjson="+JSON.stringify({
...
"use strict";
function e(){
return l&&(new Date).getTime()-l<200?!0:!1;
}
function t(){
return d.isPc||d.isWp?!1:!0;
}
function n(n,a,o,i){
t()?(a.tap_handler=function(t){
if(-1==d.tsTime||+new Date-d.tsTime>200||e())return d.tsTime=-1,!1;
var n=t.changedTouches[0];
return Math.abs(d.y-n.clientY)<=5&&Math.abs(d.x-n.clientX)<=5?a.call(this,t):void 0;
},r(n,"touchend",i,a.tap_handler,o)):r(n,"click",i,a,o);
}
function a(e,t,n,a){
var o=this,i=0;
if(d.isPc||d.isWp){
var c,u,l,s=!1;
r(e,"mousedown",a,function(e){
l=!1,s=!0,c=e.clientX,u=e.clientY,i=setTimeout(function(){
l=!0,i=0,t.call(o,e);
},500),e.preventDefault();
}),r(e,"mousemove",a,function(e){
s&&(Math.abs(u-e.clientY)>5||Math.abs(c-e.clientX)>5)&&(clearTimeout(i),i=0);
}),r(e,"mouseup",a,function(){
s=!1,clearTimeout(i);
}),r(e,"click",a,function(){
return l?!1:void 0;
});
}else r(e,"touchstart",a,function(e){
i=setTimeout(function(){
i=0,t.call(o,e);
},500),e.preventDefault();
}),r(e,"touchmove",a,function(e){
var t=e.changedTouches[0];
(Math.abs(d.y-t.clientY)>5||Math.abs(d.x-t.clientX)>5)&&(clearTimeout(i),i=0);
}),r(e,"touchend",a,function(){
clearTimeout(i);
});
}
function o(e,t){
...
function i(e,t,n){
for(;e&&!o(e,t);)e=e!==n&&e.nodeType!==e.DOCUMENT_NODE&&e.parentNode;
return e;
}
function r(e,t,o,r,c){
var u,l,s;
return"input"==t&&d.isPc,e?("function"==typeof o&&(c=r,r=o,o=""),"string"!=typeof o&&(o=""),
e==window&&"load"==t&&/complete|loaded/.test(document.readyState)?r({
type:"load"
}):"tap"==t?n(e,r,c,o):"longtap"===t?a(e,r,c,o):("unload"==t&&"onpagehide"in window&&(t="pagehide"),
u=function(e){
var t=r(e);
return t===!1&&(e.stopPropagation&&e.stopPropagation(),e.preventDefault&&e.preventDefault()),
t;
},o&&"."==o.charAt(0)&&(s=function(t){
var n=t.target||t.srcElement,a=i(n,o,e);
return a?(t.delegatedTarget=a,u(t)):void 0;
}),l=s||u,r[t+"_handler"]=l,e.addEventListener?void e.addEventListener(t,l,!!c):e.attachEvent?void e.attachEvent("on"+t,l,!!c):void 0)):void 0;
}
function c(e,n,a,o){
if(e){
var i,r=n;
return"tap"==r&&(t()?(r="touchend",i=a.tap_handler&&a.tap_handler.touchend_handler?a.tap_handler.touchend_handler:a):r="click"),
i=a[r+"_handler"]||a,e.removeEventListener?void e.removeEventListener(r,i,!!o):e.detachEvent?void e.detachEvent("on"+r,i,!!o):void("tap"==r&&t()?(a.tap_handler&&(a.tap_handler.touchend_handler=null),
a.tap_handler=null):a[r+"_handler"]=null);
}
}
var u=navigator.userAgent,d={
isPc:/(WindowsNT)|(Windows NT)|(Macintosh)/i.test(navigator.userAgent),
isWp:/Windows\sPhone/i.test(u),
tsTime:-1
};
t()&&r(document,"touchstart",function(e){
var t=e.changedTouches[0];
d.x=t.clientX,d.y=t.clientY,d.tsTime=+new Date;
});
var l;
