...
try{
nt++,nt>1&&s(F.moreList,encodeURIComponent(c)),tt.indexOf(c)>-1&&s(F.repeatList,encodeURIComponent(c)),
tt.push(c);
}catch(d){}
...
error:function(){
s(F.errList,"type:ajaxerr;url:"+encodeURIComponent(c)),U("[Appmsg comment] get comment ajax error");
},
complete:function(){
...
ot++,ot>1&&s(F.handleList,encodeURIComponent(JSON.stringify({
comment_id:O,
offset:Q,
url:location.href
...
(e.friend_comment.length>0||e.elected_comment.length>0)&&(document.getElementById("js_cmt_title").style.display="block"),
function(){
...
m(z),document.getElementById("js_cmt_title").style.display="block";
}
...
0!=m.ret&&s(F.addCommentErr,"type:resperr;url:"+encodeURIComponent(o)+";ret="+m.ret);
},
error:function(e){
J.log("shit;"+e.status+";"+e.statusText),s(F.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(o));
},
complete:function(){
...
}else K=0,s(F.errComment,"type:resperr;url:"+encodeURIComponent(e)+";ret="+i);
},
error:function(){
K=0,s(F.errComment,"type:ajaxerr;url:"+encodeURIComponent(e));
},
complete:function(){
i(t);
}
...
try{
var _=l.nick_name+l.content,r=!1,p=F.repeatContentID;
et[_]&&(r=!0,p=F.repeatContent),V.indexOf(l.content_id)>-1&&(r=!0,p=F.repeatContentID),
...
0==W.mylist.children.length&&i(W.mylist.parentNode),W.list.children.length+W.fdlist.children.length==0&&(document.getElementById("js_cmt_title").style.display="none"),
v();
}
}else o("删除失败，请重试");
},
