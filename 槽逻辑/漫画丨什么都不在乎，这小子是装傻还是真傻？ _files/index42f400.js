...
void(e.avatarTitle=e.game_info.nick_name)):void((e.pos_type===AD_POS.POS_MID&&(a===AD_TYPE.ADD_CONTACT_PRODUCT_TYPE||a===AD_TYPE.BRAND_GDT_PRODUCT_TYPE)||e.pos_type!==AD_POS.POS_MID)&&e.biz_info&&e.biz_info.head_img&&(e.avatar=e.biz_info.head_img,
...
for(var T=g.exp_info.exp_value||[],w=!1,A=0,E=0;E<T.length;++E){
var h=T[E]||{};
if(1==h.exp_type&&(A=h.comm_attention_num,w=A>0),2==h.exp_type){
w=!1,A=0;
break;
}
}
g.biz_info.show_comm_attention_num=w,g.biz_info.comm_attention_num=A,f={
...
if($=g.crt_size,(v===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||v===AD_TYPE.IOS_APP_PRODUCT_TYPE)&&(X=!0),
...
g=_parseExpCpc(g);
var Z,ta;
(g.avatarTitle||g.exp_obj.sale_text)&&g.avatar&&(Z=g.avatarTitle||g.exp_obj.sale_text,
ta=g.avatar),ea={
tag_pos:g.exp_obj.tag_pos,
type:g.tag_pos,
ticket:g.ticket,
...
var ia="&tid="+g.traceid+"&uin="+uin+"&key="+key+"&ticket="+(g.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+g.adid+"&ad_engine=0&pos_type="+g.pos_type+"&exp_id="+g.exp_info.exp_id+"&exp_value="+g.exp_info.exp_value+"&r="+Math.random();
g.report_param=ia;
}
var _a=require("a/sponsor.js");
new _a({
...
var ia="&tid="+g.traceid+"&uin="+uin+"&key="+key+"&ticket="+(g.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+g.adid+"&ad_engine=0&pos_type="+pos_type+"&exp_id="+g.exp_info.exp_id+"&exp_value="+g.exp_info.exp_value+"&r="+Math.random();
g.report_param=ia;
var na=ad_render_object["pos_"+g.pos_type].getWrapperElm().getElementsByClassName("js_video_container_new_protocol");
na[0]&&(na=na[0],g.videoContainer=na,videoAdMap[g.aid]=new VideoAd(g));
}
...
var E="";
c&&c.weapp_info&&c.weapp_info.original_id&&(E=c.weapp_info.original_id),AdClickReport({
click_pos:1,
report_type:2,
type:e,
exp_id:T,
...
if(o&&o.has_installed&&("104"==p.pt||"113"==p.pt||"114"==p.pt||"2"==p.pt)?report(114,f):"103"==p.pt||"111"==p.pt||"112"==p.pt?report(23,f):("104"==p.pt||"113"==p.pt||"114"==p.pt)&&report(25,f),
...
var i,c,l,u,g=a.type,y=a.url,P=a.rl,v=a.apurl,D=a.ticket,T=a.group_id,w=a.pt,A=o.use_new_protocol;
return i=position.getX(t,"js_material_"+r)+e.offsetX,c=position.getY(t,"js_material_"+r)+e.offsetY,
l=m[0].clientWidth,u=m[0].clientHeight,ad_click(g,y,P,v,n,D,T,_,w,d,s,p,i,c,l,u,o,f,A),
log("[Ad] ad_click: type="+g+", url="+y+", rl="+P+", apurl="+v+", traceid="+n+", ticket="+D+", group_id="+T+", aid="+_+", pt="+w+", pos_type="+d+", ad_engine="+s),
!1;
}
...
var g=require("a/app_card.js"),y=15,P=p.pkgname&&p.pkgname.replace(/\./g,"_");
new g({
btn:u[0],
adData:p,
report_param:f,
...
via:[p.traceid,p.adid,P,source,y,s].join("."),
ticket:p.ticket,
appdetail_params:["&aid="+p.adid,"traceid="+p.traceid,"pkgname="+P,"source="+source,"type="+y,"engine="+s,"appuin="+biz,"pos_type="+d,"ticket="+p.ticket,"scene="+scene].join("&"),
engine:s,
...
w=u[0].clientWidth,A=u[0].clientHeight,ad_click(i,_,n,c,l,m,f,g,y,d,s,p,D,T,w,A,o,v,P),
log("[Ad] ad_click: type="+i+", url="+_+", rl="+n+", apurl="+c+", traceid="+l+", ticket="+m+", group_id="+f+", aid="+g+", pt="+y+", pos_type="+d+", ad_engine="+s),
!1;
});
}else for(var D=0,T=t.length;T>D;++D)!function(e,a){
...
p.adid=window.adid||p.adid||p.aid;
var w=o.exp_info||{},A=w.exp_id||"",E=w.exp_value||[];
try{
E=JSON.stringify(E);
}catch(h){
E="[]";
}
var f="&tid="+p.traceid+"&uin="+uin+"&key="+key+"&ticket="+(p.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+p.adid+"&ad_engine="+s+"&pos_type="+d+"&exp_id="+A+"&exp_value="+E+"&r="+Math.random();
...
var g=require("a/app_card.js"),y=15,P=p.pkgname&&p.pkgname.replace(/\./g,"_"),b=document.getElementById("js_ad_btn_"+d);
new g({
btn:b,
adData:p,
report_param:f,
...
if("102"==p.pt){
var x=require("a/android.js"),y=15,P=p.pkgname&&p.pkgname.replace(/\./g,"_");
return void new x({
btn:document.getElementById("js_app_action_"+d),
adData:p,
report_param:f,
task_ext_info:[p.adid,p.traceid,P,source,y,s].join("."),
via:[p.traceid,p.adid,P,source,y,s].join(".")
});
}
if("101"==p.pt){
