...
if(n.url_scheme&&u.gtVersion("6.5.6",!0)){
...
messageExt:n.url_scheme,
appID:n.data.app_info.open_platform_appid,
installSchemeUrl:n.data.app_info.appinfo_url,
installAction:d
};
c.invoke("launchApplication",l,function(a){
(-1===a.err_msg.indexOf("ok")||"fail"===a.launchInstallResult)&&j(n.data.appinfo_url,s);
});
}else j(n.data.appinfo_url,s);
}else{
if(f)return t.report(16),void(location.href="tmast://download?oplist=1,2&pname="+n.data.pkgname+n.channelid+n.via);
t.report(15);
var p=[n.data.adid,n.data.traceid,(n.data.pkgname||"").replace(/\./g,"_"),n.data.source,i,a.engine].join("."),_=function(a,t,n){
...
console.log("addDownloadTask : "+n.data.appname+","+n.data.androiddownurl+","+p+","+n.data.md5sum),
_(n,p,function(a){
var s=a.err_msg;
