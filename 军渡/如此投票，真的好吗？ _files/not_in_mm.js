...
duration:e.duration,
title:i,
singer:window.nickname?window.nickname+"Recommend":"公众号推荐的歌",
epname:"音乐",
...
document.getElementById("js_preview_reward_link_text").innerText="Reply by author",
k.on(document.getElementById("js_preview_reward_author_link"),"tap",function(e){
