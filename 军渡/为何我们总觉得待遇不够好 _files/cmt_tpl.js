...
function n(e){
return console.log(e),location.href=e,!1;
}
function i(e){
var i=e.adData,l=e.pos_type||0,g={};
...
var n=t.tid,a=t.type,o=t.url,s=t.rl;
if(!g[n]){
g[n]=!0;
var c,p,d,r,_=!!e&&e.target;
_&&(c=u.getX(_,"js_ad_link")+e.offsetX,p=u.getY(_,"js_ad_link")+e.offsetY,d=document.getElementsByClassName("js_ad_link")[0]&&document.getElementsByClassName("js_ad_link")[0].clientWidth,
r=document.getElementsByClassName("js_ad_link")[0]&&document.getElementsByClassName("js_ad_link")[0].clientHeight),
m({
type:a,
report_type:2,
click_pos:0,
...
var j=e.btnAddContact,y=e.btnViewProfile;
if(j&&j.dataset){
var k=function(a,o){
var s=a.err_msg,c=i.is_appmsg?6:1;
-1!=s.indexOf("ok")?(y.style.display="inline-block",j.style.display="none",c=i.is_appmsg?9:4):"add_contact:added"==s?c=i.is_appmsg?7:2:"add_contact:cancel"==s?c=i.is_appmsg?8:3:(--o,
o>=0?f.invoke("addContact",{
scene:scene,
webtype:"1",
username:i.usename
},function(e){
k(e,o);
}):(s="addContact:fail|msg:"+s+"|uin:"+uin+"|biz:"+biz,r("http://mp.weixin.qq.com/mp/jsreport?key=13&content="+s+"&r="+Math.random()),
n(i.url))),t(c,e);
},w=function(){
t(i.is_appmsg?10:5,e),b.setSum(110696,7,1),a?b.setSum(110696,10,1):(a=!0,o=+new Date),
s?+new Date-s<2e3&&(b.setSum(110696,11,1),setTimeout(function(){
s=0;
},2e3)):s=+new Date,c?+new Date-c<3e3&&(b.setSum(110696,12,1),setTimeout(function(){
c=0;
},3e3)):c=+new Date,p?+new Date-p<4e3&&(b.setSum(110696,13,1),setTimeout(function(){
p=0;
},4e3)):p=+new Date,f.invoke("addContact",{
scene:scene,
webtype:"1",
username:i.usename
},function(e){
var t=+new Date-o;
b.setAvg(110696,9,t).send(),a=!1,k(e,1);
});
};
d.on(j,"click",_);
}
...
var t=e.btnAddContact.dataset,a={
source:4,
tid:t.tid,
idx:idx,
mid:mid,
...
var a=e.btnProfile;
if(a){
var o=function(a,s,c){
var p=a.err_msg,d=i.is_appmsg?6:1;
-1!=p.indexOf("ok")?(e.adData.biz_info.is_subscribed=1,console.log(c),c.innerHTML=c.innerHTML.replace("关注","查看"),
d=i.is_appmsg?9:4):"add_contact:added"==p?d=i.is_appmsg?7:2:"add_contact:cancel"==p?d=i.is_appmsg?8:3:(--s,
...
o(e,s,c);
}):(p="addContact:fail|msg:"+p+"|uin:"+uin+"|biz:"+biz,r("http://mp.weixin.qq.com/mp/jsreport?key=13&content="+p+"&r="+Math.random()),
n(i.url))),t(d,e);
},s=function(n){
...
d.on(a,"click",function(t){
if(console.log("has_click",g,e.adData),e.adData.biz_info.is_subscribed){
var a=e.adData;
a.tid=a.traceid;
var o={
source:4,
...
if(a.tid=a.traceid,a.rl&&a.url&&a.type&&a.tid){
var p=a.tid,d=a.type,c=a.url,r=a.rl;
if(!g[p]){
console.log("has_click[tid]",g[p]),g[p]=!0;
var f,b,j,y,k=!!t&&t.target;
k&&(f=u.getX(k,"js_ad_link")+t.offsetX,b=u.getY(k,"js_ad_link")+t.offsetY,j=document.getElementsByClassName("js_ad_link")[0]&&document.getElementsByClassName("js_ad_link")[0].clientWidth,
...
var a,o,s,c,p,d=e("biz_common/dom/event.js"),r=e("biz_common/utils/report.js"),l=e("a/a_report.js"),m=l.AdClickReport,_=(e("biz_wap/utils/ajax.js"),
e("biz_common/utils/url/parse.js")),u=e("biz_wap/utils/position.js"),f=e("biz_wap/jsapi/core.js"),b=("https:"==top.location.protocol?5:0,
...
if(t+e+100>n&&S.off(window,"scroll",s),!(Z||-1==Q||Q>0&&n-t-e>500)){
...
var c="/mp/appmsg_comment?action=getcomment&scene="+F.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+O+"&offset="+Q+"&limit="+X+(window.send_time?"&send_time="+send_time:"");
try{
nt++,nt>1&&a(F.moreList,encodeURIComponent(c)),tt.indexOf(c)>-1&&a(F.repeatList,encodeURIComponent(c)),
tt.push(c);
}catch(d){}
!!H&&console.log("[Appmsg comment] start get comment data:"+c),U("[Appmsg comment] start get comment data, url:"+c),
A({
url:c,
type:"get",
success:function(e){
...
var s=+new Date-t;
l(n,s);
}else a(F.errList,"type:resperr;url:"+encodeURIComponent(c)+";ret="+d);
U("[Appmsg comment] get comment success, text: "+e);
},
error:function(){
a(F.errList,"type:ajaxerr;url:"+encodeURIComponent(c)),U("[Appmsg comment] get comment ajax error");
},
complete:function(){
...
ot++,ot>1&&a(F.handleList,encodeURIComponent(JSON.stringify({
comment_id:O,
offset:Q,
url:location.href
...
var o="/mp/appmsg_comment?action=addcomment&scene="+F.scene+"&comment_id="+O+"&__biz="+biz+"&idx="+idx+"&appmsgid="+appmsgid+"&sn="+sn;
A({
url:o,
data:{
content:e,
...
0!=m.ret&&a(F.addCommentErr,"type:resperr;url:"+encodeURIComponent(o)+";ret="+m.ret);
},
error:function(e){
J.log("shit;"+e.status+";"+e.statusText),a(F.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(o));
},
complete:function(){
...
function p(){
if(0==K){
var e="/mp/appmsg_comment?action=getmycomment&scene="+F.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+O,t=document.getElementById("js_mycmt_loading");
K=1,m(t),A({
url:e,
type:"get",
success:function(t){
...
}else K=0,a(F.errComment,"type:resperr;url:"+encodeURIComponent(e)+";ret="+i);
},
error:function(){
K=0,a(F.errComment,"type:ajaxerr;url:"+encodeURIComponent(e));
},
complete:function(){
i(t);
}
...
l.new_appmsg=window.new_appmsg,m+=R.tmpl(T,l);
try{
var r=l.nick_name+l.content,_=!1,p=F.repeatContentID;
et[r]&&(_=!0,p=F.repeatContent),V.indexOf(l.content_id)>-1&&(_=!0,p=F.repeatContentID),
V.push(l.content_id),et[r]=!0,_&&a(p,encodeURIComponent(JSON.stringify({
comment_id:O,
...
function k(e){
var t=e.delegatedTarget,n=t.getAttribute("data-my-id"),m="/mp/appmsg_comment?action=delete&scene="+F.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&comment_id="+O+"&my_id="+n;
confirm("确定删除吗？")&&A({
url:m,
success:function(e){
var m,c=t;
...
for(var l=document.querySelectorAll(".cid"+n),a=0;a<l.length;a++)l[a].parentNode.removeChild(l[a]);
...
!!H&&console.log("comment_id:"+O+";uin:"+uin+";key:"+key),-1!=navigator.userAgent.indexOf("MicroMessenger")||window.test_comment_data||(x&&(x.style.display="none"),
z&&(z.style.display="none"),O=0,window._has_comment=!1),0==O||!uin||!key)return void(window._has_comment=!1);
var S=e("biz_common/dom/event.js"),A=e("biz_wap/utils/ajax.js"),R=(e("biz_common/utils/string/html.js"),
...
e.preventDefault();
}),S.on(W.submit,"tap",_),S.on(W.submit,"click",function(e){
e.preventDefault();
}),S.on(window,"scroll",s),S.on(window,"scroll",B),S.on(document.getElementById("js_cmt_write1"),"click",function(e){
