...
});define("appmsg/async.js",["biz_common/utils/string/html.js","appmsg/comment_utils.js","pages/create_txv.js","pages/video_ctrl.js","biz_common/utils/url/parse.js","biz_common/dom/class.js","appmsg/img_copyright_tpl.html.js","appmsg/appmsgext.js","appmsg/share_tpl.html.js","biz_common/dom/event.js","biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","biz_common/tmpl.js","biz_wap/utils/storage.js","appmsg/log.js","rt/appmsg/getappmsgext.rt.js","a/a.js","biz_wap/utils/mmversion.js","pages/version4video.js","appmsg/like.js","appmsg/reward_entry.js","a/testdata.js","appmsg/iframe.js"],function(e,t,i,n){
"use strict";
function r(){
for(var t=document.getElementsByTagName("iframe"),i=[],n=0,r=t.length;r>n;++n)i.push(t[n]);
t=null;
var o=document.getElementById("js_content"),d=o.offsetWidth,s=d/u.getRatio();
window.logs.video_cnt=0;
for(var n=0,r=i.length;r>n;++n){
var _=i[n],m=_.getAttribute("data-src")||"",c=_.getAttribute("src")||m;
if(c){
var l=e("pages/version4video.js");
if(0==c.indexOf("http://z.weishi.com/weixin/player.html"))c=c.replace(/width=\d+/g,"width="+d),
c=c.replace(/height=\d+/g,"height="+s),_.width=d,_.height=s,_.style.setProperty&&(_.style.setProperty("width",d+"px","important"),
...
if(!l.isShowMpVideo()){
var p;
p=a(j?_:_),p&&A.push(p),"function"==typeof window.__addIdKeyReport&&(window.__addIdKeyReport("28307",10),
...
var i=A[e],n=i.playerObj;
if(n){
var r=window.__getVideoWh(i);
i.style.width=r.w+"px",i.style.height=r.h+"px",n.resize({
width:r.vw,
height:r.vh
});
}
...
function a(e){
var t=e.getAttribute("data-src")||e.getAttribute("src"),i=g.getQuery("vid",t),n=e.getAttribute("data-vw"),r=e.getAttribute("data-vh"),a=e.getAttribute("data-ratio"),d=document.createElement("span");
d.setAttribute("data-ratio",a),d.id="js_tx_video_container_"+Math.random(),d.className="js_tx_video_container",
d.style.cssText=e.style.cssText,d.style.display="none";
var s=e.parentNode;
return s?(s.lastChild===e?s.appendChild(d):s.insertBefore(d,e.nextSibling),w.createTxVideo({
containerId:d.id,
vid:i,
width:n,
height:r,
...
d.playerObj=e.player,o(d,i),d.style.display="block";
},
onError:function(){}
}),s.removeChild(e),d):void 0;
}
function o(e,t){
if(t&&e){
var i=e.parentNode;
if(i){
for(var n=[],r=0,a=i.children.length;a>r;r++){
var o=i.children[r];
o.className.indexOf("img_loading")>=0&&o.getAttribute("data-vid")==t&&n.push(o);
}
for(var r=0,a=n.length;a>r;r++)i.removeChild(n[r]);
...
var d=i[a];
if(2==d.type){
if(2==n&&r==d.source_uin)continue;
t[d.img_url]={
...
var d=s[a],_=d.getAttribute("data-src")||d.getAttribute("data-backsrc")||"";
if(t[_]){
var m=document.createElement("div");
m.innerHTML=z.tmpl(v,t[_]);
{
var c=m.children[0],l=d.parentNode,p=l.insertBefore(c,d),w=p.children[0];
(function(e,t){
...
var r=document.getElementById("js_read_area3"),a=document.getElementById("like3"),o=document.getElementById("likeNum3"),d=document.getElementById("readNum3");
if(!(r&&a&&o&&d))return;
var s=e("appmsg/like.js");
i.liked=window.is_temp_url?window.liked:i.liked,s.showLikeNum({
show:!0,
likeAreaDom:a,
likeNumDom:o,
liked:i.liked,
...
function _(){
var t=E.checkNeedAds(),i=t.is_need_ad,n=t.both_ad,r=-1!=location.href.indexOf("mock_ad=");
r&&(t.is_need_ad=i=1),I("[Appmsg] start get asycn data, is_need_ad:"+i);
var a=0;
y.getData({
biz:biz,
...
i.advertisement_info=n.getAd(),i.advertisement_num=i.advertisement_info.length;
}
if(i&&i.base_resp&&i.base_resp.wxtoken&&(window.wxtoken=i.base_resp.wxtoken),window.fromWeixinCached&&e("appmsg/iframe.js"),
d(i),i.ret)return;
E.afterGetAdData(t,i),window.wx_user_can_reward=i.user_can_reward,s({
...
return window.new_appmsg&&(a=Math.floor(.8*(e-60)/r)),document.getElementById("js_reward_inner")&&(document.getElementById("js_reward_inner").style.width=a*r+"px"),
m=function(){
return a;
},a;
}
