...
});define("a/a_report.js",["biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","biz_wap/utils/mmversion.js","appmsg/log.js","a/a_sign.js"],function(t){
"use strict";
function e(t,e){
...
for(var y in t)t.hasOwnProperty(y)&&l.push(y+"="+t[y]);
var f=2;
1==window.__ad_has_exposure&&(f=1),l.push("has_exposure="+f),u+=l.join("&");
var g="trace_id="+t.tid+"&product_type="+t.pt+"&jump_url="+t.url+"&logtype=3&url="+encodeURIComponent(location.href)+"&rl="+t.rl;
t.tid&&p.gtVersion("6.3.22",!0)&&s.invoke("adDataReport",{
ad_info:g,
need_record_page_operation:1
},function(){}),_("[Ad report] url="+u),2==f&&window.__addIdKeyReport("68064",0),
window.__ad_test_exposure||window.__addIdKeyReport("68064",7),d.createSign(t,function(o,s,p,d,l){
i({
url:u,
mayAbort:!0,
type:"GET",
success:function(t){
c&&c(56+n),_("[Ad report suc]"+t),w=!0;
},
error:function(t){
c&&c(57+n),_("[Ad report error]"+t.status+":"+t.responseText);
},
complete:function(){
m||(m=!0,!!e&&e()),_("[Ad report complete]");
},
async:!0
}),setTimeout(function(){
m||(m=!0,window.__ajaxtest="1",c&&c(112),!!e&&e(),_("[Ad report timeout complete]"));
},a),setTimeout(function(){
w||i({
url:u,
type:"GET",
success:function(t){
c&&c(113+n),_("[Ad report suc retry]"+t);
},
error:function(t,e){
c&&c(114+n),_("[Ad report error retry]"+t.status+":"+t.responseText),1==e.type?c&&c(115+n):2==e.type?c&&c(116+n):3==e.type&&c&&c(117+n),
_("[Ad report error detail]"+e.toString());
}
});
},5e3),r(o,s,p,d,l,t,u);
}),o(t);
}
function r(t,e,r,o,a,n,s){
var p=s+"&ad_sign_data="+t+"&ad_sign_k1="+e+"&ad_sign_k2="+r+"&ad_sign_md5="+o+"&viewid="+a.viewid;
if(p.length>=4e3){
...
var i=t("biz_wap/utils/ajax.js"),a=location.protocol,n="https:"==a?5:0,s=t("biz_wap/jsapi/core.js"),p=t("biz_wap/utils/mmversion.js"),_=t("appmsg/log.js"),d=t("a/a_sign.js");
return{
AdClickReport:e
};
