...
window.is_new_msg&&(window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
...
e>=40&&0==j?(console.log(window.title+"init setPageTitle :top["+e+"]:title_show["+j+"]"),
document.title=window.title,j=!0):40>e&&1==j&&(console.log(window.title+"init setPageTitle :top["+e+"]:title_show["+j+"]"),
document.title="",j=!1);
},window.addEventListener("pageshow",function(){
var e=document.documentElement.scrollTop||window.pageYOffset||document.body.scrollTop;
console.log("pageshow:top="+e),e>=40?(document.title=window.title,j=!0):40>e&&(document.title="",
j=!1);
}));
...
e("appmsg/share.js");
var q=u(1e3*parseInt(top.window.modify_time)),z=q.format("YYYY-MM-DD"),B=document.getElementById("js_modify_time");
if(B&&(B.innerHTML=z),window.isSg||"mp.weixin.qq.com"==location.host){
...
(y||navigator.userAgent.indexOf("Br_trunk")>-1)&&o&&l.isIOS&&l.gtVersion("6.5.13",!0)?(console.log("当前版本可以启用img代理"),
...
is_https_res||v?a=a.http2https():("http:"==location.protocol||-1!=navigator.userAgent.indexOf("MicroMessenger"))&&(a=a.https2http())),
setTimeout(function(){
r.onload=function(){
...
window.__addIdKeyReport("28307",84)),o=E.addParam(o,"wxfrom","5",!0),is_https_res||v?(o=o.http2https(),
...
var h=window.user_uin||0,A=Math.floor(h/100)%1e3,v=0!==h&&1001>A,y=!0,b="";
