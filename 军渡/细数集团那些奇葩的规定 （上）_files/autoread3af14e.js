...
p.on(t,"tap",".js_product_loop_content",function(t){
var n=t.delegatedTarget,a=n.getAttribute("data-wxaappid"),o=n.getAttribute("data-wxapath"),p=n.getAttribute("data-pid");
return r.jumpUrl({
appid:a,
path:o,
scene:1091,
sceneNote:encodeURIComponent(location.href)+":"+encodeURIComponent(p),
beforeNonWechatWarn:function(){},
beforeJumpBackupPage:function(){},
onJsapiCallback:function(t){
if("openWeApp:ok"===t.err_msg&&p){
...
var o=document.getElementsByClassName("js_product_loop_content");
if(o&&o.length>0&&l.innerHeight){
for(var e=0;e<o.length;e++)l.pvele.push(o[e]);
a(),p.on(window,"scroll",a);
}
}
function a(){
...
var n=l.pvele[e],o=n.getBoundingClientRect(),r=o.height||o.bottom-o.top;
if(r>0&&o.top<l.innerHeight&&o.bottom>0){
var d=n.getAttribute("data-pid");
if(d){
var c=n.getAttribute("data-pidtype"),u=1;
2==c&&(u=3),t.push({
...
i(t),0==l.pvele.length&&(p.off(window,"scroll",a),a=null);
},100);
}
function o(){
setTimeout(function(){
...
var r=t("appmsg/weapp_common.js"),p=t("biz_common/dom/event.js"),d=t("biz_wap/utils/ajax.js"),c=t("biz_common/utils/url/parse.js"),u=t("biz_common/utils/monitor.js"),l={
pvele:[],
