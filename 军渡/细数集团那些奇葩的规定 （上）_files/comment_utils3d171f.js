...
"use strict";
function i(e,i){
i=i||"",i=["uin:"+a.user_uin,"resp:"+i].join("|"),(new Image).src="/mp/jsreport?key="+e+"&content="+i+"&r="+Math.random();
}
function n(){
return-1!=s.indexOf("&_newvideoplayer=0")?!1:-1!=s.indexOf("&_newvideoplayer=1")?!0:1!=a.is_login?!1:a.use_tx_video_player?!1:w.canSupportVideo&&u.inWechat?u.is_ios||u.is_android?!0:!1:(a._hasReportCanSupportVideo||w.canSupportVideo||!u.inWechat||(a._hasReportCanSupportVideo=!0,
i(44)),!1);
}
function o(){
{
...
return-1==e.indexOf("&_videoad=0")||"5a2492d450d45369cd66e9af8ee97dbd"!=a.sn&&"f62e1cb98630008303667f77c17c43d7"!=a.sn&&"30c609ee11a3a74a056e863f0e20cae2"!=a.sn?-1!=e.indexOf("&_videoad=1")?!0:-1==e.indexOf("mp.weixin.qq.com/s")&&-1==e.indexOf("mp.weixin.qq.com/mp/appmsg/show")?!1:"54"==a.appmsg_type?!1:-1!=i.indexOf("&xd=1")?!1:a.__appmsgCgiData&&a.__appmsgCgiData.can_use_page&&(u.is_ios||u.is_android)?!0:c.showAd()?!0:!1:!1;
}
function t(){
var e=s;
if(!a.user_uin)return!1;
...
var a,s,d=e("biz_common/dom/event.js"),p=e("biz_wap/jsapi/core.js"),w=e("biz_wap/utils/device.js"),c=e("new_video/ctl.js"),_=window.navigator.userAgent,f={
networkType:""
},u={};
if(parent==window)a=window,s=window.location.href;else try{
s=parent.window.location.href,a=parent.window;
}catch(h){
s=window.location.href,a=window;
}
return function(e){
var i=w.os;
...
u.wechatVer=r&&r[1]||0,d.on(window,"load",function(){
...
f.networkType=e[i.err_msg]||"fail","network_type:edge"==i.err_msg&&i.detailtype&&"4g"==i.detailtype&&(networkType="4g");
});
}
},!1);
}(window.navigator.userAgent),"undefined"==typeof a._hasReportCanSupportVideo&&(a._hasReportCanSupportVideo=!1),
{
device:u,
isShowMpVideo:n,
isUseProxy:t,
...
console.log("js click data: ",t),console.log("js click data: ",n),(y&&(12==n.product_type||19==n.product_type)||115==g)&&(h=!1,
