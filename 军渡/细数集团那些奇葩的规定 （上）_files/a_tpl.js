...
if(t+e+100>n&&S.off(window,"scroll",l),!(Z||-1==Q||Q>0&&n-t-e>500)){
...
if(i.length){
for(var d=!1,a=0;a<i.length;a++)if(!i[a].querySelector(".praise_num").innerHTML){
W.fdlist.insertBefore(o,i[a]),d=!0;
break;
}
...
a.new_appmsg=window.new_appmsg,m+=R.tmpl(T,a);
try{
...
V.push(a.content_id),et[r]=!0,_&&s(p,encodeURIComponent(JSON.stringify({
comment_id:O,
...
e.preventDefault();
}),S.on(window,"scroll",l),S.on(window,"scroll",B),S.on(document.getElementById("js_cmt_write1"),"click",function(e){
