...
var r=document.getElementById("js_video_container"),_=null,l=e.rl||"",c="";
if(l){
...
var v=null,y=!0,g=!1;
if(a.isAndroid&&a.gtVersion("6.6.6",!0)&&(g=!0),console.log(r),r){
...
window.__video_report_data.report_type=2,_.play(),o();
},
...
if(a.isAndroid&&!g)return;
d.invoke("getBackgroundAudioState",{},function(o){
...
a.isIOS&&_.triggerMuted(y),_.__beginPlayHandler(),_._trigger("beginPlay")):_.play();
}
});
}
},500);
...
n.on(document.getElementById("js_video_container"),"tap",function(o){
if(o.target.className.indexOf("js_muted_btn")>-1)"true"==_.video.getAttribute("muted")?(_.triggerMuted(!1),
y=!1):(_.triggerMuted(!0),y=!0),t(132,e.report_param);else if(!_.isPlay())return _.__beginPlayHandler(),
...
_.setHeight(o),_.setWidth(t),s.style.width=t,s.style.height=o;
},0);
});
}
