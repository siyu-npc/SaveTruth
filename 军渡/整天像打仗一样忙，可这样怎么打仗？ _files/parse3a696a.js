...
return v.length<=0&&b.length<=0&&0==k.length?!1:C&&0!=C.length?!0:!1;
}
function i(e){
...
var r=function(){};
_.on(document.getElementById("js_minipro_dialog_ok"),"click",function(){
r&&r(),document.getElementById("js_minipro_dialog").style.display="none";
}),_.on(document.getElementById("js_minipro_dialog_cancel"),"click",function(){
...
var d,s,g=!y.canJumpOnTap||y.isNonWechat,v=document.getElementById("js_pc_weapp_code"),b=document.getElementById("js_pc_weapp_code_img"),k=document.getElementById("js_pc_weapp_code_des");
g&&(_.on(v,"mouseenter",function(){
clearTimeout(d);
}),_.on(v,"mouseleave",function(){
e(v);
})),y.getAppidInfo({
...
if(C){
for(o=0;o<I.length;o++)(function(o){
var j=I[o].appid,E=I[o].path,x=I[o].imageUrl,R=I[o].title,T=I[o].elem,B=C[j];
if(B){
var z=T.tagName.toLowerCase(),K=T.firstChild&&1==T.firstChild.nodeType&&"IMG"===T.firstChild.tagName;
if(K=K||T.firstElementChild&&"IMG"===T.firstElementChild.tagName,"a"!=z)T.innerHTML=w.tmpl(f,{
imageUrl:i(x),
title:i(R),
...
}),window.__addIdKeyReport&&window.__addIdKeyReport("28307",100),n(j,o,B.nickname,R,3,e,K?2:0),
K&&window.__addIdKeyReport&&window.__addIdKeyReport("28307",115),!1;
},K&&wxa_img_alert){
document.getElementById("js_minipro_dialog_name").innerText=B.nickname;
var e=document.getElementById("js_minipro_dialog");
return e.style.display="block",e._appid=j,e._i=o,e._nickname=B.nickname,e._title=R,
n(j,o,B.nickname,R,3,1,0),y.canJumpOnTap&&window.__addIdKeyReport&&window.__addIdKeyReport("28307",114),
!1;
}
return r();
},"a"==z),g&&(_.on(T,"mouseenter",function(e){
function t(t){
function n(){
var e=v.offsetHeight,t=v.offsetWidth;
"a"!=z||K?i>t?(c(v,"right-center"),v.style.left=i-t-_+"px",v.style.top=a+"px"):(c(v),
v.style.top=a+g-e-_+"px",v.style.left=i+f-t-_+"px"):(v.style.left=p>i+f/2-t/2?p+"px":i+f/2+t/2>p+r?p+r-t+"px":i+f/2-t/2+"px",
d>e?(c(v,"down-center"),v.style.top=a-e-_+"px"):(c(v,"up-center"),v.style.top=a+g-_+"px"));
}
if(t){
var i=l(T),a=m(K?T.firstElementChild:T),p=l(T.parentNode),r=T.parentNode.offsetWidth,d=T.getBoundingClientRect().top,f=K?T.firstElementChild.offsetWidth:T.offsetWidth,g=K?T.firstElementChild.offsetHeight:T.offsetHeight,_=(e.pageX,
e.pageY,8);
k.innerText=u(B.nickname,48),b.onload=function(){
...
var f=e("pages/weapp_tpl.html.js"),g=e("biz_wap/utils/ajax.js"),_=e("biz_common/dom/event.js"),w=e("biz_common/tmpl.js"),h=e("biz_common/dom/class.js"),y=e("appmsg/weapp_common.js"),v=null,b=null,k=null,j={},I=[],C=y.appidSnInfo,E=[];
if(o()){
d(),r();
...
function i(t){
var i=[],s=t.container,o=t.imgs||[];
if(s)for(var p=s.getElementsByTagName("img")||[],d=0,g=p.length;g>d;d++)o.push(p.item(d));
for(var m=c.isIOS&&1==window._copyright_stat&&1==window.is_need_reward,u=0,d=0,g=o.length;g>d;d++){
var l=o[d],w=l.getAttribute("data-src")||l.getAttribute("src"),_=l.getAttribute("data-type");
if(w&&!w.isGif()&&0!=w.indexOf("data:")){
for(;-1!=w.indexOf("?tp=webp");)w=w.replace("?tp=webp","");
l.dataset&&l.dataset.s&&w.isCDN()&&(w=w.replace(/\/640$/,"/0"),w=w.replace(/\/640\?/,"/0?")),
w.isCDN()&&(w=n.addParam(w,"wxfrom","3",!0)),w=t.is_https_res?w.http2https():w.https2http(),
_&&(w=n.addParam(w,"wxtype",_,!0)),i.push(w),"1"!=l.getAttribute("data-nopreviewclick")&&!function(t){
r.on(l,"click",function(r){
if(!(r&&r.target&&r.target.className&&r.target.className.indexOf("img_loadederror")>-1)){
if(window.getComputedStyle){
var s=window.getComputedStyle(r.target,null),n=parseInt(s.getPropertyValue("opacity")),o=s.getPropertyValue("visibility");
if(0==n||"visible"!=o)return console.log("don' try this again"),!1;
}
e(t,i),m&&0==u&&a(r.target.src,2);
}
});
}(w),l.removeAttribute("data-nopreviewclick");
}
}
if(m){
var f=document.getElementById("js_content"),b=0,v=0;
r.on(f,"touchstart",function(t){
return t&&t.target&&t.target.tagName&&"string"==typeof t.target.tagName&&"IMG"==t.target.tagName.toString().toUpperCase()?(u=+new Date,
b=t.touches[0].pageX,void(v=t.touches[0].pageY)):void(u=0);
}),r.on(f,"touchmove",function(t){
var e=t.touches[0].pageX,a=t.touches[0].pageY;
Math.abs(e-b)>10&&Math.abs(a-v)>10&&(u=0);
}),r.on(f,"touchend",function(t){
0!=u&&(+new Date-u>800&&+new Date-u<6e3?a(t.target.src,1):u=0);
});
}
}
var r=t("biz_common/dom/event.js"),s=t("biz_wap/jsapi/core.js"),n=t("biz_common/utils/url/parse.js"),o=t("appmsg/log.js"),p=t("biz_wap/utils/ajax.js"),c=t("biz_wap/utils/mmversion.js");
