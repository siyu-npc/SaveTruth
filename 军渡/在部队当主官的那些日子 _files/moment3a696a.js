...
for(var l=+new Date,d=[],g=this.sw,u=this,p=-1,w=0,A=t.length;A>w;w++)!function(t,e){
var m=a(t.el),l=t.src;
if(l){
(l.match(/\:\/\/[^\/]+\/mmbiz\//)&&l.indexOf("wx_fmt=gif")>-1||l.match(/\:\/\/[^\/]+\/mmbiz_gif\//))&&p++;
var u=r,w=n;
(l.match(/\:\/\/[^\/]+\/mmbiz\//)&&l.indexOf("wx_fmt=gif")>-1||l.match(/\:\/\/[^\/]+\/mmbiz_gif\//))&&f&&(u=0,
w=20),!t.show&&(i>=m&&i<=m+t.height+u||m>i&&i+o+w>m)&&(e.inImgRead&&(i>=m&&i<=m+t.height||m>i&&i+o>m)&&e.inImgRead(l,networkType),
e.changeSrc&&(l=e.changeSrc(t.el,l,p)),t.el.onerror=function(){
var i=this;
...
s.isWp&&1*t.el.width>g&&(t.el.width=g);
}
}(t[w],u);
...
function e(){
var t=document.getElementsByTagName("img"),e=[],o=this.container,n=this.attrKey||"data-src",a=o.offsetWidth,s=0,r=this.imgOccupied||!1,m=this.crossOrigin||!1;
...
var g=t.item(d),u=h(g,n),p=h(g,"src");
...
r||c(g,"height",w+"px","important"),m&&-1==u.indexOf("mmsns.qpic.cn")&&!(u.match(/\:\/\/[^\/]+\/mmbiz\//)&&u.indexOf("wx_fmt=gif")>-1||u.match(/\:\/\/[^\/]+\/mmbiz_gif\//))&&(g.crossOrigin="anonymous"),
e.push({
el:g,
src:u,
height:w,
...
var s=t("biz_wap/utils/mmversion.js"),r=t("biz_common/dom/event.js"),m=t("biz_common/dom/attr.js"),h=m.attr,c=m.setProperty,l=t("biz_common/ui/imgonepx.js"),d=new Date,f=(d.getHours(),
!0);
return n;
...
});define("a/mpAdAsync.js",["appmsg/log.js","biz_wap/utils/ajax.js","rt/appmsg/getappmsgext.rt.js"],function(e){
"use strict";
function i(e,i){
function a(e){
...
var r=[];
i=i||{},e||(e=[]);
for(var m=0;m<e.length;m++)0==e[m].indexOf("wxv")&&r.push(e[m]);
o({
url:"/mp/getappmsgad?f=json&mock="+a("mock"),
data:{
r:Math.random(),
__biz:biz,
...
async:!0,
success:function(e){
if(n("[Appmsg] success get async ad data"),e.advertisement_info&&0!=e.advertisement_info.length)try{
if(n("[Appmsg] success get async ad data, async data is: "+JSON.stringify(e)),console.log("mpAsync data back",window.originalVideoAdFramesUnsetList.toString()),
window.originalVideoAdFramesAdData={},e.advertisement_info)for(var i=0;i<e.advertisement_info.length;i++)e.advertisement_info[i].cdg_appid=e.appid,
e.advertisement_info[i].vid&&(window.originalVideoAdFramesAdData[e.advertisement_info[i].vid]=d(e.advertisement_info[i]));
if(window.originalVideoAdFramesUnsetList&&0!=window.originalVideoAdFramesUnsetList.length)for(var a,o=document.getElementsByTagName("iframe"),i=0;i<window.originalVideoAdFramesUnsetList.length;i++)for(var s=0;s<o.length;s++)if(o[s].dataset&&o[s].dataset.mpvid==window.originalVideoAdFramesUnsetList[i]){
window.originalVideoAdFramesAdData[o[s].dataset.mpvid]||(window.originalVideoAdFramesAdData[o[s].dataset.mpvid]={}),
a=window.originalVideoAdFramesAdData[o[s].dataset.mpvid],o[s].contentWindow.postMessage({
action:"receiveOriginalVideoData",
vid:window.originalVideoAdFramesUnsetList[i],
adData:a
},"*");
break;
}
...
action:"receiveOriginalVideoData",
vid:r[0],
adData:window.originalVideoAdFramesAdData[r[0]]
},"*");
}catch(m){}else n("[Appmsg] success get async ad data, async data is empty"),t(r);
},
error:function(){
n("[Appmsg] error get async ad data, biz="+biz+", mid="+mid),t(r);
}
});
}
function t(e){
var i,t=document.getElementsByTagName("iframe");
if(console.log("mpadasync error and recover all video to play status"),window.originalVideoAdFramesAdData={},
window.originalVideoAdFramesUnsetList){
...
var n=e("appmsg/log.js"),o=e("biz_wap/utils/ajax.js"),s=e("rt/appmsg/getappmsgext.rt.js");
return{
getAdData:i
};
