...
if(t.share_redirect_url&&_&&(window._share_redirect_url=t.share_redirect_url,_.innerHTML=I.tmpl(f,{
...
-1==b.indexOf("WindowsWechat")&&-1!=b.indexOf("MicroMessenger")&&!z.isInMiniProgram){
...
c.setAttribute("data-timestamp",t.reward.timestamp));
}
1!=t.reward_entrance_enable_for_preview||z.isInMiniProgram||(author_id?(document.getElementById("js_preview_reward_author")&&(document.getElementById("js_preview_reward_author").style.display="block"),
...
function _(){
console.log("gaby getAsyncData");
var t=B.checkNeedAds(),r=t.is_need_ad,i=t.both_ad,n=-1!=location.href.indexOf("mock_ad="),a=-1!=location.href.indexOf("mock");
(n||a)&&(t.is_need_ad=r=1),E("[Appmsg] start get asycn data, is_need_ad:"+r);
var d=0;
v.getData({
biz:biz,
