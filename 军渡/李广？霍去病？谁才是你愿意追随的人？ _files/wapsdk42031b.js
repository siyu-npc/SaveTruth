...
"use strict";
function t(e,t){
var i="https:"==location.protocol?1500:1200,d=window.__report,c="/mp/advertisement_report?r="+Math.random()+"&ascene="+encodeURIComponent(window.ascene||-1)+"&",u=[],l=!1;
for(var w in e)e.hasOwnProperty(w)&&u.push(w+"="+e[w]);
var m=2;
1==window.__ad_has_exposure&&(m=1),u.push("has_exposure="+m),c+=u.join("&");
var j="trace_id="+e.tid+"&product_type="+e.pt+"&jump_url="+e.url+"&logtype=3&url="+encodeURIComponent(location.href)+"&rl="+e.rl;
e.tid&&s.gtVersion("6.3.22",!0)&&r.invoke("adDataReport",{
ad_info:j,
need_record_page_operation:1
},function(){}),p("[Ad report] url="+c),2==m&&window.__addIdKeyReport("68064",0),
window.__ad_test_exposure||window.__addIdKeyReport("68064",7),_.createSign(e,function(e,o,r,s,p){
c+="&ad_sign_data="+e+"&ad_sign_k1="+o+"&ad_sign_k2="+r+"&ad_sign_md5="+s+"&viewid="+p.viewid,
a({
url:c,
mayAbort:!0,
type:"GET",
...
l||(l=!0,window.__ajaxtest="1",d&&d(112),!!t&&t());
},i);
}),o(e);
}
function o(e){
...
var a=e("biz_wap/utils/ajax.js"),i=location.protocol,n="https:"==i?5:0,r=e("biz_wap/jsapi/core.js"),s=e("biz_wap/utils/mmversion.js"),p=e("appmsg/log.js"),_=e("a/a_sign.js");
return{
AdClickReport:t
};
