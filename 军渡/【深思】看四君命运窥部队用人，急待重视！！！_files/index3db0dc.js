...
});define("appmsg/index.js",["biz_common/utils/string/html.js","biz_wap/utils/device.js","biz_common/dom/class.js","appmsg/log.js","biz_wap/utils/ajax.js","biz_common/dom/attr.js","appmsg/max_age.js","biz_wap/utils/mmversion.js","appmsg/test.js","biz_common/dom/event.js","biz_wap/jsapi/core.js","biz_common/moment.js","appmsg/appmsg_report.js","page/appmsg_new/combo.css","page/appmsg_new/not_in_mm.css","page/appmsg/page_mp_article_improve_combo.css","page/appmsg/not_in_mm.css","biz_common/utils/url/parse.js","appmsg/cdn_img_lib.js","appmsg/share.js","biz_common/log/jserr.js","biz_wap/ui/lazyload_img.js","appmsg/async.js","appmsg/copyright_report.js","appmsg/outer_link.js","appmsg/review_image.js","appmsg/product.js","appmsg/iframe.js","appmsg/qqmusic.js","appmsg/voice.js","appmsg/autoread.js","appmsg/voicemsg.js","appmsg/weproduct.js","appmsg/weapp.js","appmsg/wxtopic.js","appmsg/cdn_speed_report.js","appmsg/page_pos.js","appmsg/report_and_source.js","appmsg/report.js","appmsg/fereport.js","biz_wap/safe/mutation_observer_report.js","sougou/index.js"],function(e){
"use strict";
function t(){
function t(e,t){
var o={
...
e.offsetTop<i?(t=!0,m.off(window,"scroll",o),(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=59977_15_1",
_.hotspotReport({
...
{
var x=!p.isWp&&-1==navigator.userAgent.indexOf("MicroMessenger");
-1!=navigator.userAgent.indexOf("WindowsWechat");
}
e("appmsg/share.js");
var E=w(1e3*parseInt(top.window.modify_time)),q=E.format("YYYY-MM-DD"),R=document.getElementById("js_modify_time");
if(R&&(R.innerHTML=q),window.isSg||"mp.weixin.qq.com"==location.host){
...
var z=-1!=navigator.userAgent.indexOf("TBS/"),k=function(e,o){
t(e,function(e,t){
...
z&&1>=i&&(n.lossy=n.lossless=n.alpha=1,window.logs.webplog=n);
...
(h||navigator.userAgent.indexOf("Br_trunk")>-1)&&o&&p.isIOS&&p.gtVersion("6.5.13",!0)?(console.log("当前版本可以启用img代理"),
...
window.__addIdKeyReport("28307",84)),o=I.addParam(o,"wxfrom","5",!0),is_https_res||f?(o=o.http2https(),
...
return A&&o.isGif()&&(window.__addIdKeyReport("28307",106),o=I.addParam(o,"tp","wxpic",!0),
...
for(var d=0,c=o.length;c>d;d++)!function(e){
...
-1!=navigator.userAgent.indexOf("MicroMessenger")&&(p.isIOS||p.isAndroid||p.isWp)?l.invoke("openUrlWithExtraWebview",{
url:C,
openType:1
},function(e){
...
}),d(),c(),m.tap(document.getElementById("js_hotspot_area"),function(e){
...
var _=document.getElementById("js_close_temp");
m.on(_,"click",function(){
_.parentNode.parentNode.removeChild(_.parentNode),n.removeClass(document.getElementById("js_article"),"preview_appmsg");
});
},1e3),function(){
...
var t=e.length-1,o=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop;
if(e[t].ori==n()&&(e[t].scroll=o,e[t].istouchmove=!0,!a)){
var i=(window.innerHeight||document.documentElement.clientHeight)+o;
...
var U=Math.random();
if(2e-4>U)try{
for(var L=document.getElementsByTagName("img"),P=window.screen.height,H=window.screen.width,G=0,J=window.devicePixelRatio,G="",Y=0,V=L.length;V>Y;Y++){
var F=L[Y].getAttribute("data-src");
if(F){
var X=L[Y].getBoundingClientRect();
G+=H+"|"+P+"|"+X.left.toFixed(2)+"|"+(H-X.right).toFixed(2)+"|"+X.width.toFixed(2)+"|"+J.toFixed(2)+"|"+F+";";
}
}
r({
