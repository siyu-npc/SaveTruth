...
e("appmsg/share.js");
var R=_(1e3*parseInt(top.window.modify_time)),q=R.format("YYYY-MM-DD"),B=document.getElementById("js_modify_time");
...
{
var g=l[_].getAttribute("data-src");
l[_].getAttribute("src");
}
g&&g.isGif()&&l[_].className.indexOf("__bg_gif")<0&&(l[_].className+=" __bg_gif"),
g&&o(l[_]);
}
for(var u=document.getElementsByClassName("__bg_gif"),_=0,w=u.length;w>_;++_)u[_].setAttribute("data-order",_);
new c({
attrKey:"data-src",
imgOccupied:!0,
...
var m=1e3,l=window.user_uin||0,_=0!==l&&Math.floor(l/100)%1e3<m;
_&&(n>=43305||d>=16)&&o.isGif()?(o=x.addParam(o,"tp","wxpic",!0),window.__addIdKeyReport("28307",91)):window.webp&&(o=x.addParam(o,"tp","webp",!0),
...
for(var p=0,_=o.length;_>p;p++)!function(e){
...
w.profileReport({}),profileReportInfo){
...
var w=document.getElementById("js_close_temp");
m.on(w,"click",function(){
w.parentNode.parentNode.removeChild(w.parentNode),n.removeClass(document.getElementById("js_article"),"preview_appmsg");
});
},1e3),function(){
...
r.getBoundingClientRect().top<i&&(a=!0,(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=59977_15_1");
}
});
}
