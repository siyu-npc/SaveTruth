...
var r=e("biz_common/dom/event.js"),s=e("new_video/player.html.js"),d=e("biz_wap/utils/device.js"),l=e("new_video/ctl.js"),u=e("biz_common/tmpl.js"),_=e("pages/iframe_communicate.js"),h={
_players:{},
...
var l=e.src;
if(!l)return void this.__triggerOutside("error",{
errorcode:5
});
if(r.setAttribute("origin_src",l),y)return o.find(".js_btn_play").attr("href",l).show(),
...
o.find(".js_btn_play")),u=o.find(".js_btn_play_aria"),_=o.find(".js_video_poster"),h=o.find(".js_switch"),c=o.find(".js_progress_bar"),p=o.find(".js_controll"),f=(o.find(".js_played_bar"),
...
var b,S,C,P,B=0,j=!1,k=0,F=0,D=i.__getDuration(),H=0,M=1,x=window.user_uin||0,I=0!==x&&Math.floor(x/100)%1e3<M,V=!1,L=0;
...
var r=t-b,s=a-S.x,d=o-S.y,l=Math.sqrt(Math.pow(s,2)+Math.pow(d,2))+F,u=Math.min(Math.ceil(l/r),6);
k=Math.floor(.1*l+.2*u*u*u)*Math.ceil(D/500),F=0==k?l:0,0>s&&(k=-k);
var _=180*Math.atan2(d,s)/Math.PI;
j||(_>=-30&&30>=_&&++B,(_>=150&&180>=_||_>=-180&&-150>=_)&&--B,(B>=4||-4>=B)&&(5>=l?B=0:(L=Math.max(L,u),
...
(new Image).src="/mp/jsmonitor?idkey=28307_31_1;28307_33_"+r+";28307_34_"+L,V=!0;
}
i._seekReport();
}
k=0,j=!1,B=0;
