...
var i=a.app_info.app_size||0,t=a.app_info.app_name||a.app_info.appname||"",n=a.app_info.apk_url||a.app_info.pkgurl||"",o=a.app_info.file_md5||a.app_info.pkgmd5||a.app_info.app_md5||"",p=a.app_info.apk_name||a.app_info.pkg_name||"";
i=formSize(i),t=formName(t),a.app_info.app_size=i,a.app_info.app_name=t,a.app_info.apk_name=p,
...
var a=e,i=a.app_info.app_size||0,t=a.app_info.app_name||a.app_info.appname||"",n=a.app_info.apk_url||a.app_info.pkgurl||"",o=a.app_info.file_md5||a.app_info.pkgmd5||a.app_info.app_md5||"",p=a.app_info.apk_name||a.app_info.pkg_name||"";
i=formSize(i),t=formName(t),a.app_info.app_size=i,a.app_info.app_name=t,a.app_info.apk_name=p,
a.app_info.appname=a.app_info.app_name,a.app_info.app_rating=a.app_info.app_rating||0,
a.app_info.app_id=a.app_info.app_id,a.app_info.icon_url=a.app_info.icon_url,a.app_info.channel_id=a.app_info.channel_id,
a.app_info.md5sum=a.app_info.app_md5,a.app_info.rl=a.rl,a.app_info.pkgname=p,a.app_info.url_scheme=a.app_info.url_scheme,
...
var k=f.app_info.down_count||0,P=f.app_info.app_size||0,O=f.app_info.app_name||"",I=f.app_info.category,D=["万","百万","亿"];
if(k>=1e4){
k/=1e4;
for(var A=0;k>=10&&2>A;)k/=100,A++;
k=k.toFixed(1)+D[A]+"次";
}else k=k.toFixed(1)+"次";
P=formSize(P),I=I?I[0]||"其他":"其他",O=formName(O),f.app_info._down_count=k,f.app_info._app_size=P,
f.app_info._category=I,f.app_info.app_name=O,u={
appname:f.app_info.app_name,
...
var T=f.card_info.card_id||"",E=f.card_info.card_ext||"";
E=E.htmlDecode();
try{
...
i&&Class.addClass(i,"show"),DomEvent.off(window,"scroll",R);
}
},U=adDatas.ads;
...
var H=document.getElementsByClassName("js_download_app_card")[0],Y=H.offsetWidth,L=Math.floor(Y/2.875);
L>0&&(H.style.height=L+"px");
}
...
if(F=f.crt_size,f.biz_info&&f.biz_info.head_img&&23===v&&(f.avatar=f.biz_info.head_img,
...
}),ad_render_object["pos_"+f.pos_type]=new CrtManager.createCrtObject(F,V,js_cpc_area,Q),
...
isApp:!1
},ad_render_object["pos_"+f.pos_type]=new CrtManager.createCrtObject(F,V,js_sponsor_ad_area,Q),
...
try{
for(var n=JSON.parse(t.replace(/&quot;/g,'"')),o=-1,p=0;p<n.aid_list.length;p++)n.aid_list[p].aid==e.aid&&(o=p);
o>-1&&(i.icon_pos=n.icon_pos||"",i.btn_text=n.btn_text||i.btn_text,i.price=n.aid_list[o].price,
i.sale_text=n.aid_list[o].sale_text,window.__addIdKeyReport("68064",15));
}catch(_){
...
t||(t=setTimeout(p,a),_&&e.apply(n,o));
};
}
function seeAds(){
...
return i&&i[1]&&parseInt(i[1].split("_")[0],10)>=12?void OpenUrlWithExtraWebview("http://"+location.host+"/mp/ad_redirect?url="+encodeURIComponent(e)+"&ticket="+a+"#wechat_redirect"):void JSAPI.invoke("downloadAppInternal",{
appUrl:e
},function(i){
...
function ad_click(e,a,i,t,n,o,p,_,r,d,s,c,l,m,u,f,g,y,v){
if(!has_click[n]){
has_click[n]=!0;
...
if(v)1==g.dest_type?handleH5(a,n,idx,mid,biz,r,_,s,d,c,g):6==g.dest_type?Wxopen_card.openWxopen(c):h===ANDROID_APP_PRODUCT_TYPE||h===IOS_APP_PRODUCT_TYPE?handleApp(a,n,idx,mid,biz,r,_,s,d,c,g,o,y):0==g.dest_type?OpenUrlWithExtraWebview(a):(console.info("[APPMSG AD DEBUG] new protocol debug click:",g),
OpenUrlWithExtraWebview(a));else if("5"==e)OpenUrlWithExtraWebview("/mp/profile?source=from_ad&tousername="+a+"&ticket="+o+"&uin="+uin+"&key="+key+"&__biz="+biz+"&mid="+mid+"&idx="+idx+"&tid="+n);else{
...
-1==e.err_msg.indexOf("ok")&&openWebAppStore(a,o);
}):openWebAppStore(a,o),!1;
...
var p="",l="";
c&&(p=c.pkgname&&c.pkgname.replace(/\./g,"_"),l=c.channel_id||""),i={
source:4,
tid:n,
traceid:n,
mid:mid,
...
var t=i.getElementsByClassName("js_ad_link")||[],n=adDatas.ads[a],o=i.getElementsByClassName("js_ad_opt_list_btn_"+e),p=i.getElementsByClassName("js_complain_btn_"+e);
if(n){
...
if(i&&3!=s.pos_type){
var n=i.type,o=i.url,p=i.rl,u=i.apurl,f=i.ticket,g=i.group_id,y=i.pt,v=s.use_new_protocol;
if(d){
...
x=m[0].clientWidth,j=m[0].clientHeight,ad_click(n,o,p,u,r,f,g,_,y,c,l,d,h,b,x,j,s,w,v),
...
var i=m[0].dataset,t=!!a&&a.target,n=i.type,o=s.button_action.jump_url,p=i.rl,_=i.apurl,r=i.tid,f=i.ticket,g=i.group_id,y=i.aid,v=i.pt,w=s.use_new_protocol;
...
j=u[0].clientWidth,k=u[0].clientHeight,ad_click(n,o,p,_,r,f,g,y,v,c,l,d,b,x,j,k,s,h,w),
...
ad_click(o,p,d,m,r,u,f,_,g,c,l,a,v,w,h,b,s,n,y),log("[Ad] ad_click: type="+o+", url="+p+", rl="+d+", apurl="+m+", traceid="+r+", ticket="+u+", group_id="+f+", aid="+_+", pt="+g+", pos_type="+c+", ad_engine="+l),
!1;
}
...
function handleApp(e,a,i,t,n,o,p,_,r,d,s,c,l){
...
function handleH5(e,a,i,t,n,o,p,_,r,d,s){
