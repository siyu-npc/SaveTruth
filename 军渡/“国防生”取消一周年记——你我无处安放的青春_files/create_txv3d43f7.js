...
document.getElementById("js_reward_avatar")&&u.off(document.getElementById("js_reward_avatar"),"click",z),
s({
...
console.log(e),void g.invoke("openUrlWithExtraWebview",{
url:e,
openType:1
},function(t){
...
var m=document.getElementById("js_reward_link"),w=document.getElementById("js_reward_avatar");
...
}),b=o(s.replace(a,"&__tc=1"+a)),z=o(s),u.on(m,"click",b),author_id&&u.on(w,"click",z),
...
E&&f>0&&n(E);
var I=document.getElementById("js_reward_total");
I&&(I.innerText=e.reward_total,I.setAttribute("href",l));
}
function m(e,t){
...
if(e){
for(var a=0,n=j.length;n>a&&(t++,m(r,j[a]),t!=3*w);++a);
...
console.log("gaby afterGetAdData"),console.log(e);
...
o.advertisement_num=a.advertisement_num,console.log("ret.advertisement_info: "),
console.log(a.advertisement_info);
}
...
var E=u.card_info.card_id||"",A=u.card_info.card_ext||"";
A=A.htmlDecode();
try{
A=JSON.parse(A),A.outer_str=u.card_info.card_outer_id||"",A=JSON.stringify(A);
}catch(D){
A="{}";
}
f={
...
var z=u.mp_shop_info.pid||"",O=u.mp_shop_info.outer_id||"";
f={
pid:z,
outer_id:O,
pt:u.pt,
...
var P=document.getElementsByClassName("js_download_app_card")[0],N=P.offsetWidth,H=Math.floor(N/2.875);
H>0&&(P.style.height=H+"px");
}
}else if(3==u.pos_type){
var P=document.createElement("div");
P.appendChild(document.createTextNode(u.image_url)),u.image_url=P.innerHTML.replace(/&amp;/g,"&"),
...
108==u.pt||109==u.pt||110==u.pt?document.getElementById("js_main_img").style.height=U/1.77+"px":116==u.pt||117==u.pt,
...
function ad_click(e,a,t,p,i,o,n,_,r,d,s,c,l,m,f,u,g,y,h){
if(!has_click[i]){
has_click[i]=!0;
var v=document.getElementById("loading_"+i);
...
if(has_click[i]=!1,v&&(v.style.display="none"),g.canvas_info)return console.log(" jsapi invoke OpenADCanvas"),
...
if(h)1==g.dest_type?p(a,i,idx,mid,biz,r,_,s,d,c,g):6==g.dest_type?Wxopen_card.openWxopen(c):12==g.product_type||19==g.product_type?t(a,i,idx,mid,biz,r,_,s,d,c,g):0==g.dest_type?location.href=a:(console.info("[APPMSG AD DEBUG] new protocol debug click:",g),
...
if(i&&3!=r.pos_type){
var _=i.type,c=i.url,l=i.rl,m=i.apurl,f=i.tid,u=i.ticket,g=i.group_id,y=i.aid,h=i.pt,v=r.use_new_protocol,w=!0;
(v&&(12==r.product_type||19==r.product_type)||115==h)&&(w=!1,console.log("js dom event type: ",w)),
...
if(!t||!t.className||4==d&&a&&-1==p.toString().indexOf(a.product_type)||-1==t.className.indexOf("js_ad_btn")&&-1==t.className.indexOf("js_btn_process")&&-1==t.className.indexOf("js_muted_btn")&&-1==t.className.indexOf("js_poster_cover")&&-1==t.className.indexOf("js_ad_opt_list_btn")&&-1==t.className.indexOf("js_complain_btn")){
if(a){
...
ad_click(_,c,l,m,f,u,g,y,h,d,s,a,o,n,w,x,r,i,v),log("[Ad] ad_click: type="+_+", url="+c+", rl="+l+", apurl="+m+", traceid="+f+", ticket="+u+", group_id="+g+", aid="+y+", pt="+h+", pos_type="+d+", ad_engine="+s),
!1;
}
...
var globalAdDebug=!1,pos_type=window.pos_type||0,__report=window.__report,total_pos_type=5,el_gdt_areas={
pos_4:js_cpc_area,
